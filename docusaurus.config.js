...
const config = {
  ...
  themeConfig: (
...

    {
      ...
      announcementBar: {
        id: "vcluster-v0-31-eos-archive",
        content:
          '⚠️ <strong>This is an archived EOS version of vCluster v0.31 documentation.</strong> For the latest docs, visit <a href="https://vcluster.com/docs/vcluster/">vcluster.com/docs/vcluster</a>.',
