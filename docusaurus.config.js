        ...
        sitemap: {
          ...
          createSitemapItems: async (params) => {
            ...
            return filteredItems.map((item) => {
              ...
              // Latest stable versions get highest priority (0.27.0 for vCluster, 4.4.0 for platform)
  ...
  themeConfig: (
...

    {
      ...
      announcementBar: {
        ...
        content:
          '🚀 <strong>New releases: <a href="https://www.vcluster.com/releases/en/changelog?hideLogo=true&hideMenu=true&theme=dark&embed=true&c=vCluster" target="_blank">vCluster Platform 4.4 and vCluster 0.27</a></strong>',
