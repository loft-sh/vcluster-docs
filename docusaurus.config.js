...
const config = {
  ...
  themeConfig: (
...

    {
      ...
      announcementBar: {
        id: "vcluster-0-29-archived",
        content:
          '⚠️ <strong>This is an archived version of vCluster 0.29 documentation.</strong> View the <a href="https://vcluster.com/docs/vcluster/">latest vCluster docs</a>.',
