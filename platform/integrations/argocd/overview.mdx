...
Choose the Akuity integration if your Argo CD instance is managed by Akuity. Akuity connects to clusters through an in-cluster agent that connects outward, bypassing the Platform proxy for cluster-side reconciliation.
