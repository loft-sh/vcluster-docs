...
<Flow id="rancher-plugin-create-vcluster">
  ...
  <Step>
    Enter a name for the virtual cluster and select the vCluster Platform Project in which you wish to create the virtual cluster. Only those projects which have the <a href="../projects/rancher#project-based-rancher-integration">Rancher Integration</a> enabled would be displayed in the list.
  </Step>
  <Step>
