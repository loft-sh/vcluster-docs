...
The built-in Rancher integration was removed in vCluster Platform v4.9.0. This migration guide walks you through moving your existing tenant clusters from the built-in Rancher integration to the [vCluster Rancher operator](/docs/vcluster/third-party-integrations/rancher), the supported replacement.
