...
## Enable vCluster Platform project with the Rancher Integration

### Using the UI

Before being able to enable virtual clusters with the Rancher integration, it must be enabled on the project. 
