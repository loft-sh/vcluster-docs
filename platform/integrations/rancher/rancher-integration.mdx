...
This guide describes a legacy integration method for Rancher and is outdated. For current install instructions and supported workflows, see the [Install Rancher](./install-rancher-integration) docuemntation.
