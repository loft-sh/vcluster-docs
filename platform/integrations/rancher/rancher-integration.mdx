...
:::warning Deprecated
The `rancher-nodeless-plugin` is deprecated. If you need to remove virtual node resources from Rancher, use the [vCluster Rancher integration](/docs/vcluster/third-party-integrations/rancher/install-rancher-integration) instead.
:::
