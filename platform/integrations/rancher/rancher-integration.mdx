...
This guide describes a legacy integration method for Rancher and is outdated. For current install instructions and supported workflows, see [Install the Rancher integration in vCluster](/docs/vcluster/third-party-integrations/rancher/install-rancher-integration).
...
:::warning Deprecated
The `rancher-nodeless-plugin` is deprecated. If you need to remove virtual node resources from Rancher, use the [vCluster Rancher integration](/docs/vcluster/third-party-integrations/rancher/install-rancher-integration#remove-virtual-node-resources) instead.
:::
