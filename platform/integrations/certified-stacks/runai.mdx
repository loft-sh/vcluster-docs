...
configuration options, and step-by-step setup instructions. Version 2 of certified stacks is under active
development starting with NVIDIA Run:ai. You can find those
templates in the certified-stacks repository [v2 section](https://github.com/loft-sh/certified-stacks/tree/main/v2/run-ai).
