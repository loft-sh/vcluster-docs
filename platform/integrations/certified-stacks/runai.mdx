...
Use the `runai-tenant` VirtualClusterTemplate. It creates a tenant cluster and adds a `run-ai-dedicated-control-plane` StackInstance named `runai` through [`deploy.stacks`](/docs/vcluster/next/configure/vcluster-yaml/deploy#platform-stacks).
