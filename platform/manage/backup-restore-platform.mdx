...
```
vcluster platform backup --filename vcluster-platform-backup.yaml
```
...
```
vcluster platform backup --namespace my-namespace
```
...
```
vcluster platform backup --skip users,teams
```
