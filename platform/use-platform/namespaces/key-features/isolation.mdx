...
limits and network policies. To make your life easier, vCluster Platform is deployed with a default Space
...
To enforce storage limits inside a cluster, including per-PVC size caps and storage class restrictions, see [Enforce storage quotas per cluster](../../../how-to/enforce-storage-quotas.mdx).
