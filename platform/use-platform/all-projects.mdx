...
All Projects doesn't bypass project permissions. It starts with the projects visible to your user, filters out projects pending deletion, and shows resources from the remaining active projects. If you support multiple customers, each mapped to a project, All Projects gives you a single place to check status and find the resources that need attention.
...
| View | Use it to |
| --- | --- |
| [All Tenant Clusters](./virtual-clusters/add-virtual-clusters.mdx) | Review tenant clusters, their status, project, template, owner, version, and control plane placement. |
| [All Namespaces](../understand/what-are-namespaces.mdx) | Review namespaces, their status, project, template, owner, and control plane cluster. |
...
| [All Network Environments](../administer/node-providers/overview.mdx#node-environments) | Review network environments, their project, provider, owner, and default status. |
