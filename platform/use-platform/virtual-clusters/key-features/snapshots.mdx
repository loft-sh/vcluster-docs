...
For more details on how snapshots work, refer to the documentation in the [Snapshot and Restore](/vcluster/next/manage/backup-restore/volume-snapshots) section.
...
Check the [Volume Snapshot](/vcluster/next/manage/backup-restore/volume-snapshots) documentation page to learn more about getting your cluster ready for snapshotting volumes
:::
