...
Check the [Volume Snapshot](/vcluster/manage/backup-restore/volume-snapshots) documentation page to learn more about getting your cluster ready for snapshotting volumes
:::
