...
vCluster Platform lets you associate custom links to cluster instances, for example to point to a github pull request or jira issue.
...
<Tabs
    ...
    <TabItem value="ui">
    1. Select your project from the project selector, then click <NavStep>Clusters</NavStep>.
    1. Edit an existing cluster or create a new one.
    ...
    1. Click <Button>Create Cluster</Button>, or <Button>Save Changes</Button> if you're editing an existing cluster, to apply all changes.
    </TabItem>
<TabItem value="cli">
