...
- Restrict manual virtual cluster creation to platform admins only
- Enable [required templates](../../../administer/projects/allowed/templates.mdx#security-best-practices) for all projects where non-admin users create virtual clusters
