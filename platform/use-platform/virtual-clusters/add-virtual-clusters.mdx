...
- **[Sleep mode](/docs/vcluster/configure/vcluster-yaml/sleep)**: Automatic sleep/wake, to include the vCluster control plane, based on activity to save resources
...
- Configure [sleep mode](/docs/vcluster/configure/vcluster-yaml/sleep) for cost optimization
