...
```
The platform access key is provided as a Kubernetes Secret. You can find more information of how to create such Secret at the [`apiKey` configuration section of vCluster.](../../../../vcluster/configure/vcluster-yaml/external/platform/api-key).
