...
```
The platform access key can only be provided as a Kubernetes Secret. You can find more information of how to create such Secret at the [`apiKey` configuration section of vCluster.](/docs/vcluster/next/configure/vcluster-yaml/platform#platform-apiKey).
...
- **[Sleep mode](/docs/vcluster/next/configure/vcluster-yaml/sleep)**: Automatic sleep/wake, to include the vCluster control plane, based on activity to save resources
...
- Configure [sleep mode](/docs/vcluster/next/configure/vcluster-yaml/sleep) for cost optimization
