...
You can also use Helm values by updating the `vcluster.yaml` to include the [access key](../../../api/authentication) of the platform and then upgrade or restart
the virtual cluster. More information can be found at the [`apiKey` configuration section of vCluster.](../../../../vcluster/configure/vcluster-yaml/external/platform/api-key)
...
<Flow id="helm-to-platform">
  <Step>
    **Deploy vCluster with Helm**
    ...
    Deploy your vCluster using Helm or your preferred deployment tool. For detailed Platform installation instructions, see the [Platform Helm installation guide](/platform/install/helm).
