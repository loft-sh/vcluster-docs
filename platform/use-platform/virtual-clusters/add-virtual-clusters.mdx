...
- **[SSO integration](/platform/configure/platform-configs/single-sign-on/overview)**: <GlossaryTerm term="user">User</GlossaryTerm> access through Platform SSO providers
- **[Audit logging](/platform/configure/platform-configs/audit)**: Centralized audit trails for compliance
