...
Machines represent provisioned servers managed by vCluster Platform. Each Machine is backed by a [node provider](../../administer/node-providers/overview.mdx) that handles the actual provisioning — creating VMs, provisioning on bare metal servers, or running Terraform scripts.
