---
title: What Are Project Secrets
sidebar_label: What Are Project Secrets
sidebar_position: 2
---
...
project secret and populate it with its own secret data. The second is to sync a project secret with a [global secret](../../understand/what-are-secrets.mdx).
