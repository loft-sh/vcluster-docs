...
bash scripts, helm charts, etc. See the [Apps section](/platform/apps/what-are-apps.mdx), and be sure to learn about [versioning](/platform/apps/versioning.mdx) and [parameters](/platform/apps/parameters.mdx).
