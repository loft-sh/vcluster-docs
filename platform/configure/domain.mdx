...
import PartialAdminUpgrade from "../_partials/deploy/upgrade.mdx";
...
If you want to [configure the platform with additionalCA](/platform/configure/config.mdx#setting-additional-certificate-authority-for-platform), the Certificate Authority used for signing this certificate has to be added as a base64 encoded value:
...
If you want to [configure the platform with additionalCA](/platform/configure/config.mdx#setting-additional-certificate-authority-for-platform), use:
