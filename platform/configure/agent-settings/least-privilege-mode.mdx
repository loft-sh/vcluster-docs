...
The following configuration options are available:
 ...
 - **Managed namespaces scope permissions** – Controls the permissions granted to the vCluster Platform Agent into the namespaces where cluster instances are installed.
...
Requests for the disabled features will not be fulfilled. For example, if the ProjectQuotas feature is disabled, the project quotas will not be enforced for the cluster instances deployed on the connected cluster.
...
<details className="config-field" data-expandable="true" open>
  ...
  <details className="config-field" data-expandable="true">
    ...
    <details className="config-field" data-expandable="true" open>
      ...
      If set to `false`, project quotas will not be enforced for the cluster instances deployed on the connected cluster.
    </details>
  </details>
  <details className="config-field" data-expandable="true">
    <summary>
  ...
  <details className="config-field" data-expandable="true">
    ...
    <details className="config-field" data-expandable="true" open>
      ...
      If set to `false`, sleep/auto-sleep/wake actions will be ignored for the cluster instances deployed on the connected cluster.
    </details>
  </details>
  <details className="config-field" data-expandable="true">
    <summary>
  ...
  <details className="config-field" data-expandable="true">
    ...
    The vCluster Platform Agent namespace-admin Role provides permissions to allow the agent to manage cluster instances within a managed namespace, without cluster-admin level permissions.
    As part of the cluster instances reconciliation loop, the namespace-admin role is created in the managed namespace and assigned to the vCluster Platform Agent service account.
    ...
    <details className="config-field" data-expandable="true">
      <summary>
        ##### `extraRules` <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span>
        Allows granting additional permissions to the vCluster Platform Agent within the managed namespaces where cluster instances are installed.
      </summary>
...
3. Verify deployment:
   - Confirm that cluster instances can be deployed as expected.
...
## Troubleshoot least privilege mode
...
If you need more help troubleshooting agent behavior, see [Troubleshoot connected cluster connection failures](../../troubleshoot/connected-cluster-connectivity.mdx).
