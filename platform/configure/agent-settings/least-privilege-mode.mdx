...
The following configuration options are available:
 - **Feature toggles** - Enable/disable toggles for the features that should be supported by the agent (ClusterAccess, ProjectQuota, Secrets, SleepMode).
...
<details className="config-field" data-expandable="true" open>
  ...
  <details className="config-field" data-expandable="true">
    ...
    <details className="config-field" data-expandable="true" open>
      ...
      If set to `false`, Global/Project secrets will not be synchronized with the local cluster.
    </details>
  </details>
  <details className="config-field" data-expandable="true">
    <summary>
