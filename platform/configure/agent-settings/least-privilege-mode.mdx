...
In order to keep the agent permissions scoped to your deployment needs, the agent upgrade process is expected to not be managed automatically by the vCluster Platform.

See [Agent Upgrade / Disable Agent Upgrades](agent-upgrade.mdx#disable-agent-upgrades) for more details.
:::
