...
#### `insecureCa` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-oidc-insecureCa}
...
#### `getUserInfo` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-oidc-getUserInfo}
...
#### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-oidc-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-oidc-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-oidc-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-oidc-clusterAccountTemplates-accountName}
...
#### `groupClusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-oidc-groupClusterAccountTemplates}
...
##### `group` <span className="config-field-required" data-required="true">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-oidc-groupClusterAccountTemplates-group}
...
##### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-oidc-groupClusterAccountTemplates-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-oidc-groupClusterAccountTemplates-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-oidc-groupClusterAccountTemplates-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-oidc-groupClusterAccountTemplates-clusterAccountTemplates-accountName}
...
#### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-github-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-github-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-github-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-github-clusterAccountTemplates-accountName}
...
#### `groupClusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-github-groupClusterAccountTemplates}
...
##### `group` <span className="config-field-required" data-required="true">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-github-groupClusterAccountTemplates-group}
...
##### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-github-groupClusterAccountTemplates-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-github-groupClusterAccountTemplates-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-github-groupClusterAccountTemplates-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-github-groupClusterAccountTemplates-clusterAccountTemplates-accountName}
...
#### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-gitlab-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-gitlab-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-gitlab-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-gitlab-clusterAccountTemplates-accountName}
...
#### `groupClusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-gitlab-groupClusterAccountTemplates}
...
##### `group` <span className="config-field-required" data-required="true">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-gitlab-groupClusterAccountTemplates-group}
...
##### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-gitlab-groupClusterAccountTemplates-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-gitlab-groupClusterAccountTemplates-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-gitlab-groupClusterAccountTemplates-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-gitlab-groupClusterAccountTemplates-clusterAccountTemplates-accountName}
...
#### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-google-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-google-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-google-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-google-clusterAccountTemplates-accountName}
...
#### `groupClusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-google-groupClusterAccountTemplates}
...
##### `group` <span className="config-field-required" data-required="true">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-google-groupClusterAccountTemplates-group}
...
##### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-google-groupClusterAccountTemplates-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-google-groupClusterAccountTemplates-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-google-groupClusterAccountTemplates-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-google-groupClusterAccountTemplates-clusterAccountTemplates-accountName}
...
#### `onlySecurityGroups` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-microsoft-onlySecurityGroups}
...
#### `useGroupsAsWhitelist` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-microsoft-useGroupsAsWhitelist}
...
#### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-microsoft-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-microsoft-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-microsoft-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-microsoft-clusterAccountTemplates-accountName}
...
#### `groupClusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-microsoft-groupClusterAccountTemplates}
...
##### `group` <span className="config-field-required" data-required="true">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-microsoft-groupClusterAccountTemplates-group}
...
##### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-microsoft-groupClusterAccountTemplates-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-microsoft-groupClusterAccountTemplates-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-microsoft-groupClusterAccountTemplates-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-microsoft-groupClusterAccountTemplates-clusterAccountTemplates-accountName}
...
#### `insecureSkipSignatureValidation` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-saml-insecureSkipSignatureValidation}
...
#### `filterGroups` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-saml-filterGroups}
...
#### `insecure` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-rancher-insecure}
...
#### `disabled` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">true</span> <span className="config-field-enum"></span> {#auth-password-disabled}
...
##### `insecureCa` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-oidc-insecureCa}
...
##### `getUserInfo` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-oidc-getUserInfo}
...
##### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-oidc-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-oidc-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-oidc-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-oidc-clusterAccountTemplates-accountName}
...
##### `groupClusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-oidc-groupClusterAccountTemplates}
...
##### `group` <span className="config-field-required" data-required="true">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-oidc-groupClusterAccountTemplates-group}
...
##### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-oidc-groupClusterAccountTemplates-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-oidc-groupClusterAccountTemplates-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-oidc-groupClusterAccountTemplates-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-oidc-groupClusterAccountTemplates-clusterAccountTemplates-accountName}
...
##### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-github-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-github-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-github-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-github-clusterAccountTemplates-accountName}
...
##### `groupClusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-github-groupClusterAccountTemplates}
...
##### `group` <span className="config-field-required" data-required="true">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-github-groupClusterAccountTemplates-group}
...
##### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-github-groupClusterAccountTemplates-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-github-groupClusterAccountTemplates-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-github-groupClusterAccountTemplates-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-github-groupClusterAccountTemplates-clusterAccountTemplates-accountName}
...
##### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-gitlab-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-gitlab-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-gitlab-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-gitlab-clusterAccountTemplates-accountName}
...
##### `groupClusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-gitlab-groupClusterAccountTemplates}
...
##### `group` <span className="config-field-required" data-required="true">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-gitlab-groupClusterAccountTemplates-group}
...
##### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-gitlab-groupClusterAccountTemplates-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-gitlab-groupClusterAccountTemplates-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-gitlab-groupClusterAccountTemplates-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-gitlab-groupClusterAccountTemplates-clusterAccountTemplates-accountName}
...
##### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-google-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-google-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-google-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-google-clusterAccountTemplates-accountName}
...
##### `groupClusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-google-groupClusterAccountTemplates}
...
##### `group` <span className="config-field-required" data-required="true">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-google-groupClusterAccountTemplates-group}
...
##### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-google-groupClusterAccountTemplates-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-google-groupClusterAccountTemplates-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-google-groupClusterAccountTemplates-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-google-groupClusterAccountTemplates-clusterAccountTemplates-accountName}
...
##### `onlySecurityGroups` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-microsoft-onlySecurityGroups}
...
##### `useGroupsAsWhitelist` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-microsoft-useGroupsAsWhitelist}
...
##### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-microsoft-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-microsoft-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-microsoft-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-microsoft-clusterAccountTemplates-accountName}
...
##### `groupClusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-microsoft-groupClusterAccountTemplates}
...
##### `group` <span className="config-field-required" data-required="true">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-microsoft-groupClusterAccountTemplates-group}
...
##### `clusterAccountTemplates` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">object[]</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-microsoft-groupClusterAccountTemplates-clusterAccountTemplates}
...
##### `name` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-microsoft-groupClusterAccountTemplates-clusterAccountTemplates-name}
...
##### `sync` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-microsoft-groupClusterAccountTemplates-clusterAccountTemplates-sync}
...
##### `accountName` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default"></span> <span className="config-field-enum"></span> {#auth-connectors-microsoft-groupClusterAccountTemplates-clusterAccountTemplates-accountName}
...
##### `insecureSkipSignatureValidation` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-saml-insecureSkipSignatureValidation}
...
##### `filterGroups` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-connectors-saml-filterGroups}
...
### `disableTeamCreation` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#auth-disableTeamCreation}
...
### `enabled` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">true</span> <span className="config-field-enum"></span> {#oidc-enabled}
...
### `wildcardRedirect` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">true</span> <span className="config-field-enum"></span> {#oidc-wildcardRedirect}
...
### `noDefault` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#apps-noDefault}
...
#### `insecure` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#apps-repositories-insecure}
...
### `enabled` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#audit-enabled}
...
### `disableAgentSyncBack` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#audit-disableAgentSyncBack}
...
### `compress` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#audit-compress}
...
LogoURL is url pointing to the logo to use in the UI. This path must be accessible for clients accessing
the UI!
...
### `enabled` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#vault-enabled}
...
### `skipTLSVerify` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#vault-skipTLSVerify}
...
##### `optional` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">boolean</span> <span className="config-field-default">false</span> <span className="config-field-enum"></span> {#vault-auth-tokenSecretRef-optional}
