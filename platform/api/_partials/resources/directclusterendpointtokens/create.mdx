...
You can either use curl or kubectl to create a new Regional Cluster Endpoint Token.
...
Then create the Regional Cluster Endpoint Token `my-object` with:
```bash
...
Run the following curl command to create a new Regional Cluster Endpoint Token `my-object`:
```bash
