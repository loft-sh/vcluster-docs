...
import Reference from "@site/platform/api/_partials/resources/teams/reference.mdx";
import Retrieve from "@site/platform/api/_partials/resources/teams/retrieve.mdx";
import Create from "@site/platform/api/_partials/resources/teams/create.mdx";
import Update from "@site/platform/api/_partials/resources/teams/update.mdx";
import Delete from "@site/platform/api/_partials/resources/teams/delete.mdx";
