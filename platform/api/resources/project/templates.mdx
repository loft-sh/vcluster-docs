...
import Reference from "@site/platform/api/_partials/resources/projects/templates/reference.mdx";
import SubResourceGet from "@site/platform/api/_partials/resources/projects/templates/subresourceget.mdx";
