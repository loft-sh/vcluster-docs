...
In order to access the vCluster platform management api, you'll need a vCluster platform access key. See [access keys](../administer/authentication/access-key.mdx) for more information how to create a new access key.
