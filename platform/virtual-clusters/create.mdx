...
sidebar_label: Create Virtual Cluster
...
Each virtual cluster that is created in the platform belongs to a [project](../projects/what-are-projects). There are two primary ways which
virtual clusters can be created: from a template or manually.

Virtual clusters created from a [template](../templates/what-are-templates/) inherit all template
...
each project adhere to the standards set by the project admin(s).
