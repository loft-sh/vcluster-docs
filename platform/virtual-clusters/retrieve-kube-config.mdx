...
:::info
If you have direct [cluster endpoints](../clusters/multi-region-mode.mdx) or
...
You can also create a kubeconfig manually by creating an [access key](../users/access-keys.mdx) for
