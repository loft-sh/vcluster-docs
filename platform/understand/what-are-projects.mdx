...
Use [All Projects](../use-platform/all-projects.mdx) to view tenant clusters, namespaces, machines, and network environments across the projects you can access.
