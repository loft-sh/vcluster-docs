...
Each project can define secrets to be used within the project. See the [Manage Project Secrets](../use-platform/secrets/secrets.mdx) section for more information.
