...
See the [Manage Allowed Templates](../administer/projects/templates.mdx) section for more information.

### Allowed Clusters

Each project may define specific clusters that members of the project have access to. The member users and teams
will have their roles propagated to each allowed cluster. See the [Manage Allowed Clusters](../administer/projects/clusters.mdx) section for more information.
