...
| **SSO Group** | A representation of a group from your [configured SSO provider](https://www.vcluster.com/docs/platform/configure/platform-configs/single-sign-on/overview). These groups are imported during authentication and stored in User records. |
...
1. Configure Microsoft Entra ID as your SSO provider using either:
   - [OIDC configuration](https://www.vcluster.com/docs/platform/configure/platform-configs/single-sign-on/providers/microsoft)
   - [SAML configuration](https://www.vcluster.com/docs/platform/configure/platform-configs/single-sign-on/providers/saml)
...
- [Single sign-on configuration](https://www.vcluster.com/docs/platform/configure/platform-configs/single-sign-on/overview)
