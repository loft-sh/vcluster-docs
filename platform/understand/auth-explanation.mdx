...
| **Project** | An organizational unit for resources such as clusters. [Projects](https://www.vcluster.com/docs/platform/understand/what-are-projects) help enforce access control and resource quotas.|
...
1. Configure Microsoft Entra ID as your SSO provider using either:
   - [OIDC configuration](https://www.vcluster.com/docs/platform/configure/platform-configs/single-sign-on)
   - [SAML configuration](https://www.vcluster.com/docs/platform/configure/platform-configs/single-sign-on)
...
2. **DevOps Engineers** - Create and manage clusters within projects
3. **Developers** - Connect to and use clusters
...
- [Single sign-on configuration](https://www.vcluster.com/docs/platform/configure/platform-configs/single-sign-on)
- [Platform permissions reference](https://www.vcluster.com/docs/platform/administer/users-permissions/permissions/platform)
- [SSO group synchronization](https://www.vcluster.com/docs/platform/configure/platform-configs/single-sign-on#sso-group-sync)