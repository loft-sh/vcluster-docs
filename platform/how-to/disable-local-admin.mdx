...
2. If the admin account doesn't exist, create and rotate its password using [Recover through Helm](../administer/authentication/reset-admin-password.mdx#recover-through-helm). This supports installations with an external database.
