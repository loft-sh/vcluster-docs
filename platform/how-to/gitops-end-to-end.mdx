...
Store `StackTemplate` and `StackInstance` resources with the other Platform resources in your Git repository. A StackTemplate is cluster-scoped. Create each StackInstance in its project's `p-<project-name>` namespace.
