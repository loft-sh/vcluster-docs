...
Stack parameters and outputs are rendering contexts, not general Go template functions. For their validation rules and supported locations, see [Create a Stack template](../administer/templates/create-stack-templates.mdx#pass-outputs-between-tasks).
