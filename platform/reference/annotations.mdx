...
sidebar_position: 5
description: Reference documentation for vcluster.loft.sh and sleepmode.loft.sh annotations and labels used by vCluster
---
...
This page documents the well-known annotations and labels in the `vcluster.loft.sh` and `sleepmode.loft.sh` namespaces used by vCluster.

For platform-specific annotations (`loft.sh/*`), see the [Platform Annotations Reference](/docs/platform/reference/platform-annotations).
