...
Provide a comma-separated list of user group names.
...
Provide a comma-separated list of `resource` or `resource.group` values.
...
Format: `resource[.group]=verb1 verb2,resource2[.group]=verb3`.
