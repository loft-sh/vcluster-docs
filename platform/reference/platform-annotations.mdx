...
## Sleep mode annotations (sleepmode.loft.sh) {#sleepmode-annotations}
...
### drift.loft.sh/force-infrastructure-check {#drift-loft-sh-force-infrastructure-check}

**Type:** Annotation

**Example:** `drift.loft.sh/force-infrastructure-check: ""`

Needs documentation.

### drift.loft.sh/force-kubernetes-check {#drift-loft-sh-force-kubernetes-check}

**Type:** Annotation

**Example:** `drift.loft.sh/force-kubernetes-check: ""`
...
LoftHelmReleaseAppVersionAnnotation indicates the version of the loft app

### loft.sh/apply {#loft-sh-apply}

**Type:** Annotation

**Example:** `loft.sh/apply: ""`

Needs documentation.

### loft.sh/argo-integration {#loft-sh-argo-integration}

**Type:** Label

**Example:** `loft.sh/argo-integration: ""`
...
### loft.sh/auth-callback {#loft-sh-auth-callback}

**Type:** Annotation

**Example:** `loft.sh/auth-callback: ""`
...
### loft.sh/cluster-role-template {#loft-sh-cluster-role-template}

**Type:** Label

**Example:** `loft.sh/cluster-role-template: ""`

Needs documentation.

### loft.sh/default-version {#loft-sh-default-version}

**Type:** Annotation

**Example:** `loft.sh/default-version: ""`
...
### loft.sh/hosts {#loft-sh-hosts}

**Type:** Annotation

**Example:** `loft.sh/hosts: ""`

Needs documentation.

### loft.sh/ignore {#loft-sh-ignore}

**Type:** Annotation

**Example:** `loft.sh/ignore: ""`

Needs documentation.

### loft.sh/import-rancher {#loft-sh-import-rancher}

**Type:** Label

**Example:** `loft.sh/import-rancher: ""`
...
LoftHelmInsecureSkipTlsAnnotation holds if tls check should be skipped during helm upgrade

### loft.sh/is-managed {#loft-sh-is-managed}

**Type:** Annotation

**Example:** `loft.sh/is-managed: ""`

Needs documentation.

### loft.sh/last-applied-parameter-defaults {#loft-sh-last-applied-parameter-defaults}

**Type:** Annotation

**Example:** `loft.sh/last-applied-parameter-defaults: ""`

Needs documentation.

### loft.sh/last-seen {#loft-sh-last-seen}

**Type:** Annotation

**Example:** `loft.sh/last-seen: ""`

won't reconnect, so we can cleanup the vCluster & its access key.

### loft.sh/loft-project-name {#loft-sh-loft-project-name}

**Type:** Label

**Example:** `loft.sh/loft-project-name: ""`
...
**Example:** `loft.sh/managed: ""`

make sure all the required cluster role bindings are there
...
### loft.sh/project-admin {#loft-sh-project-admin}

**Type:** Label

**Example:** `loft.sh/project-admin: ""`

Needs documentation.

### loft.sh/project-name {#loft-sh-project-name}

**Type:** Label

**Example:** `loft.sh/project-name: ""`
...
### loft.sh/rancher-cluster-id {#loft-sh-rancher-cluster-id}

**Type:** Annotation

**Example:** `loft.sh/rancher-cluster-id: ""`

Needs documentation.

### loft.sh/rancher-integration {#loft-sh-rancher-integration}

**Type:** Label

**Example:** `loft.sh/rancher-integration: ""`
...
### loft.sh/rancher-last-synced-members {#loft-sh-rancher-last-synced-members}

**Type:** Annotation

**Example:** `loft.sh/rancher-last-synced-members: ""`

Needs documentation.

### loft.sh/require-ingress-authentication {#loft-sh-require-ingress-authentication}

**Type:** Annotation

**Example:** `loft.sh/require-ingress-authentication: ""`

Needs documentation.

### loft.sh/skip-update {#loft-sh-skip-update}

**Type:** Annotation

**Example:** `loft.sh/skip-update: ""`

Needs documentation.

### loft.sh/space-role {#loft-sh-space-role}

**Type:** Label

**Example:** `loft.sh/space-role: ""`
...
LoftHelmRepositoryURLAnnotation holds the repository url the release was deployed from
...
### loft.sh/vault-kv-mount-path {#loft-sh-vault-kv-mount-path}

**Type:** Annotation

**Example:** `loft.sh/vault-kv-mount-path: ""`

and global/shared secrets

### loft.sh/vault-kv-secret-path {#loft-sh-vault-kv-secret-path}

**Type:** Annotation

**Example:** `loft.sh/vault-kv-secret-path: ""`

Needs documentation.

### loft.sh/vault-kv-version {#loft-sh-vault-kv-version}

**Type:** Annotation

**Example:** `loft.sh/vault-kv-version: ""`

Annotations used for vault integration on project secrets and global/shared secrets

### loft.sh/vcluster-control-plane {#loft-sh-vcluster-control-plane}

**Type:** Label

**Example:** `loft.sh/vcluster-control-plane: ""`

Needs documentation.

### loft.sh/virtual-cluster-name {#loft-sh-virtual-cluster-name}

**Type:** Label

**Example:** `loft.sh/virtual-cluster-name: ""`
...
VClusterPlatformAccessKeyCooldownSeconds is a label added to AccessKeys that indicates a duration, in seconds, that should be used instead of the default cooldown
...
IsBrowserShellNamespaceAnnotation is used to indicate and confirm that a namespace was create for the browser shell feature
...
VClusterPlatformShellPodUIDLabel is a label added to AccessKeys that indicates they are associated with the pod possessing the UID in the corresponding value.
...
SleepModeEndpointSlicesAnnotation stores the original endpoint slice to be restored
...
SleepModeEndpointsSubsetsAnnotation stores the original endpoint subsets to be restored
...
SleepModeIstioVirtualServiceHTTPRoutes stores the original istio virtual service HTTP routes.
...
SleepModeIstioVirtualServiceSleeping indicates VirtualServices should continue to try to reconcile to sleep if present or be restored when removed.
...
### sleepmode.loft.sh/quota {#sleepmode-loft-sh-quota}

**Type:** Label

**Example:** `sleepmode.loft.sh/quota: ""`
...
SleepModeServicePortsAnnotation stores the original service ports to be restored
...
SleepModeServiceSelectorAnnotation stores the original service selector to be restored
...
SleepModeTargetServiceNameAnnotation stores the target service name
...
SleepModeTargetServiceNamespaceAnnotation stores the target service name, if service is in a different namespace
...
SleepModeTargetServicePortAnnotation stores the target service port. Can be a name or port number.

### vcluster.loft.sh/agent-installed {#vcluster-loft-sh-agent-installed}

**Type:** Annotation

**Example:** `vcluster.loft.sh/agent-installed: ""`
...
**Example:** `vcluster.loft.sh/node-claim-name: ""`
...
**Example:** `vcluster.loft.sh/node-claim-namespace: ""`
...
**Example:** `vcluster.loft.sh/static-node-pool: ""`
