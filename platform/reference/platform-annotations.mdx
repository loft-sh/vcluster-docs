...
**Example:** `vcluster.loft.sh/join-script-endpoint: "https://cluster.example.com/join-script"`

**Used on:** ConfigMap (kubeadm-config)

**Set by:** Platform

The HTTPS endpoint URL for the kubeadm join script used during node registration.
