...
For vCluster-specific annotations (`vcluster.loft.sh/*`, `sleepmode.loft.sh/*`), see the [Annotations and Labels Reference](/docs/platform/reference/annotations).
...
These annotations configure sleep mode behavior. For sleep mode status annotations, see the [Annotations Reference](/docs/platform/reference/annotations#sleep-mode-status-annotations).
