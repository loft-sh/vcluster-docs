...
| OTLP gRPC | `https://gateway-fleet-observability.vcluster-platform.svc.cluster.local:4317` |

The gateway always uses TLS. The OpenTelemetry Collector `otlphttp` exporter accepts the
