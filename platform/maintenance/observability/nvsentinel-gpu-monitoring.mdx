...
- The [NVIDIA GPU Operator](https://docs.nvidia.com/datacenter/cloud-native/gpu-operator/latest/index.html) is deployed in the same cluster, per the [deployment order](./gpu-monitoring-templates.mdx#deployment-order).
