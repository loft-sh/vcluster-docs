...
Create the Fleet Observability connector in the Platform namespace. It must use the name
`fleet-observability` and the label `loft.sh/fleet-observability-connector: "true"`.
...
<Flow>
  ...
  <Step>
    ...
    For the Fleet Observability connector, use a display name that resolves to the ID `fleet-observability`.
  </Step>
  <Step>
