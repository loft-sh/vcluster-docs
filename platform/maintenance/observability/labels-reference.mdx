...
|---|---|---|---|
| `cluster` | Fleet monitoring with OpenTelemetry | Control plane cluster identity | `vcluster_platform_cluster` |
...
Not sure which guide fits your environment in the first place? See
[Choose a fleet metrics path](../monitoring/choose-a-fleet-metrics-path.mdx).
