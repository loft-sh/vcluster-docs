...
Do this only if you're also moving <GlossaryTerm term="tenant-cluster">clusters</GlossaryTerm> to a new vCluster
...
After mirroring, update the chart version on any cluster templates that
