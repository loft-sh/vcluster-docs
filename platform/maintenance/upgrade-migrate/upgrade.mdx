...
:::info Upgrading to Platform 4.12
Platform 4.12 removes the resources that deployed apps before this release. If you have any apps deployed, see [Upgrade to Platform 4.12](#upgrade-to-4-12) after completing the upgrade steps below.
:::
