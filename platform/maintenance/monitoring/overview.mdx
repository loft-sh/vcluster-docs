...
- [Aggregating metrics with OpenTelemetry](./aggregating-metrics) — simpler setup with Prometheus, OpenTelemetry Collector, and Grafana
- [Fleet monitoring with OpenTelemetry](./fleet-monitoring-otel) — advanced collector examples for Shared Nodes and Private Nodes tenancy models
