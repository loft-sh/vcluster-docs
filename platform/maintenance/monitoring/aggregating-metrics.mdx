...
collect workload metrics from across multiple tenant clusters and aggregate by
Project, <GlossaryTerm term="vcluster">vCluster</GlossaryTerm>, and Space. This approach uses shared OpenTelemetry DaemonSets on the <GlossaryTerm term="control-plane-cluster">control plane cluster</GlossaryTerm> without requiring individual collector installations per <GlossaryTerm term="tenant-cluster">tenant cluster</GlossaryTerm>.
