...
- **Prometheus outside the tenant cluster** (on the control plane cluster or a central monitoring instance): use [Fleet Observability](../observability/overview.mdx). If it isn't available for your deployment, use [Option 1](#option-1-otel-fleet-monitoring-reference-architecture).
