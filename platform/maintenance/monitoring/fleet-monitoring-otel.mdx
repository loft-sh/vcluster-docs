...
sidebar_position: 3
description: "Monitor tenant clusters across shared and private nodes using OpenTelemetry Collectors with ingest-time label enrichment and Prometheus remote write."
---
