...
When managing many tenant clusters across <GlossaryTerm term="control-plane">Control Plane</GlossaryTerm> Clusters, you need per-tenant
...
- Collector architecture:
  ...
  - One OTel Collector Deployment with Target Allocator per <GlossaryTerm term="control-plane-cluster">Control Plane Cluster</GlossaryTerm> (scrapes shared-nodes tenant clusters and their control planes using ServiceMonitors).
