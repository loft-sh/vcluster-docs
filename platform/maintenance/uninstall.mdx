...
CRDs managed with driver Helm are deleted, but the underlying clusters
are not uninstalled.
...
- Uninstalls Helm releases related to vCluster Platform.
...
[troubleshooting](/docs/platform/use-platform/troubleshooting)
