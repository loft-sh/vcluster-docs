...
sidebar_label: Manage Project Secrets
...
project secret and populate it with its own secret data. The second is to sync a project secret with a [global secret](../secrets/).
