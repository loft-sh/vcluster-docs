...
Projects, clusters, and standalone machines share environments rather than owning them, and `Project.spec.allowedNetworkEnvironments` narrows which ones a project can use.
