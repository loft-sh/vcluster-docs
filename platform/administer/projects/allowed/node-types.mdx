...
Allowed node types control which [node types](../../../vmetal/concepts/machine-types-and-nodetypes.mdx) can be referenced by NodeClaims created in a project. Use this to restrict tenants to a subset of the node types available on the platform. For example, you can use this to limit a project to a specific provider or instance class.
