...
Once the project secret has been created, head over to the [Secret Sync](../../users-permissions/permissions/secrets/secret-sync.mdx) page to learn how to use the project secret data from a Pod.
