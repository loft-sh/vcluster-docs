...
Only platform administrators can open the Inbox. Administrators can access it from the **Inbox** entry in the left navigation, just above the account name. When unread announcements are available, the entry shows an unread count.
