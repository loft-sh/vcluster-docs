...
creates a non-privileged user. Read more about vCluster's using of external databases in the [vCluster External Database docs](../../../vcluster/configure/vcluster-yaml/control-plane/components/backing-store/connector/database).
