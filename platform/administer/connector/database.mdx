...
The database connector secret can be created in the UI by navigating to `Databases > Connect Database Secrets` from the sidebar.

Alternatively, a Secret yaml manifest can be applied to the vCluster Platform's host cluster.
