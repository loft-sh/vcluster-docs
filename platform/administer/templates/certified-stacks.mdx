...
After creation, monitor the generated StackInstance for the tenant cluster. Then follow [Verify a deployment](#verify-a-deployment) below. A healthy Helm task alone doesn't prove that the NVIDIA Run:ai scheduler is ready.
