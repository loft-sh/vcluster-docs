...
to make changes over time to a template while retaining the current version/iteration. Resources (i.e. virtual clusters, spaces) that are deployed with templates that have updated versions show up with a warning
