...
To update a virtual cluster that references a deleted template, you must edit the virtual cluster's custom resource directly. This requires manually editing the associated CustomResourceDefinition (CRD).
