...
This does not affect any virtual clusters that were already created from the template.

:::warning Delete a virtual cluster template

Virtual clusters that reference a deleted template cannot be edited or upgraded through the Platform UI using the form-based editor.
