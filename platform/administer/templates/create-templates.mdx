...
Templates can be created directly in the UI.
...
Templates include configuration sections that control template behavior, content, and access. The following configuration options can be applied to virtual cluster templates and namespace templates.
