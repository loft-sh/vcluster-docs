...
<Flow id="create-vcluster-template-ui">
  <Step>
   Go to <NavStep>Management > Templates</NavStep> and, if shown, click the <Label>Clusters</Label> tab.
  </Step>
...
<Flow id="create-stack-template">
  <Step>
    Go to <NavStep>Management > Stacks & Apps</NavStep>, and select the <Label>Stacks</Label> tab.
  </Step>
  <Step>
...
<Flow>
  <Step>
    Go to <NavStep>Management > Templates</NavStep> or <NavStep>Management > Apps</NavStep>. If a tab bar is shown, click the tab for the template type (<Label>Clusters</Label>, <Label>Namespaces</Label>, <Label>ArgoCD Apps</Label>, or <Label>Helm Apps</Label>).
  </Step>
  <Step>
