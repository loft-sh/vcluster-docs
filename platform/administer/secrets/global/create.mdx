...
<Flow id="secret-create-global-secret">
  <Step>
    Go to <NavStep>Secrets & Credentials > Global Secrets</NavStep>.
  </Step>
  <Step>
  ...
  <Step>
    Click <Button>Add Rule</Button> to add an access rule.
  </Step>
  <Step>
