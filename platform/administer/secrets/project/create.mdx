...
Project secrets let you define and share secrets across the clusters where your project's namespaces and clusters run. There are two ways to populate a project secret:
