...
<Flow id="secret-create-project-secret-data">
  ...
  <Step>
    Click on the <Button>Create Project Secret</Button> button to save your changes
  </Step>
</Flow>
...
<Flow id="create-project-secret-from-shared-secret">
  ...
  <Step>
    In the <NavStep>Data</NavStep>, enable the <Label>Synchronize data from a global secret</Label> option, then select the global secret in the <Label>Select a Global Secret</Label> dropdown.
  </Step>
  <Step>
    Click on <NavStep>Management Access</NavStep>. Add which users and teams have access and permissions to modify the project secret.
  </Step>
  <Step>
    Click on the <Button>Create Project Secret</Button> button to save your changes.
  </Step>
