...
:::
  ...
  If you haven't already, you need to [create access key](/docs/platform/next/authentication/access-keys#create-an-access-key) to be able to login to the platform.
