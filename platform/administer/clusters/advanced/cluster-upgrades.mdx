...
<Tabs
  ...
  If you haven't already, you need to [create access key](/docs/platform/administer/authentication/access-keys.mdx#create-an-access-key) to be able to login to the platform.
