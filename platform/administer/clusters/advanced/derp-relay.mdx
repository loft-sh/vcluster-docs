...
DERP (Designated Encrypted Relay for Packets) is a relay protocol used by Tailscale when direct WireGuard peer-to-peer connections cannot be established. This happens when firewalls, NAT, or restrictive network policies block direct communication between agents.
