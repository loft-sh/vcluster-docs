...
You shoud allow egress traffic from vCluster pods to the `lostHost` domain and the egree traffic from platform agent to `loftHost`, if it participates in the handshake in your setup.
