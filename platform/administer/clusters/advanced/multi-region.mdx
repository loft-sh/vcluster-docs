...
| | Multi-region platform | [Regional Cluster Endpoints](direct-cluster-endpoints.mdx) |
|---|---|---|
...
platform, see [Regional Cluster Endpoints](direct-cluster-endpoints.mdx). For details on how
