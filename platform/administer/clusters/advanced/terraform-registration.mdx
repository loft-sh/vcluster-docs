...
Navigate to <NavStep>Infrastructure > Control Plane Clusters</NavStep> in the Platform interface. Your cluster should appear with "Connected" status within moments.
