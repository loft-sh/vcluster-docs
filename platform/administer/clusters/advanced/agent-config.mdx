...
:::warning
If you do not install vCluster Platform agent into a connected cluster at all, certain features, such as Spaces, <GlossaryTerm term="sleep">Sleep</GlossaryTerm>, Apps, Accounts, Account Quotas & Security Templates will not be available in the cluster
:::
