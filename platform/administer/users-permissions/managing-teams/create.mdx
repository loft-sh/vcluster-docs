  ...
  <Step>
    ...
    <Flow id="create-team-optional-ui">
      <Step>
        ...
        <Label>Team Members</Label> selector allows you to include
        individual users directly into the team, while the
        <Label>SSO groups</Label> field allows you to include users whose standard
      ...
      <Step>
        ...
        logging into vCluster Platform (using the vCluster CLI).
      </Step>
      <Step>
...
3. Team memberships propagate to all clusters managed by the platform.
