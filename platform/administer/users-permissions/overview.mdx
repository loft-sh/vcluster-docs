...
[Users and Teams](/platform/understand/what-are-users-and-teams.mdx), as well as
[SSO Configuration Options](./sso/openid-connect.mdx) as building out a complete RBAC design will
...
Configuring SSO in vCluster Platform is documented [here](./sso/openid-connect.mdx), for purposes of this
