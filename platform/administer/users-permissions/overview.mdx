...
[Users and Teams](../../understand/what-are-users-and-teams.mdx), as well as
[SSO Configuration Options](../../configure/single-sign-on/providers/openid-connect.mdx) as building out a complete RBAC design will
...
Check out the [Impersonate](./managing-users/impersonate.mdx) docs section for the basics of impersonation.
...
Configuring SSO in vCluster Platform is documented [here](../../configure/single-sign-on/providers/openid-connect.mdx), for purposes of this
