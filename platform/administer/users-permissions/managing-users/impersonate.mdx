...
<Flow id="impersonate-user">
  ...
  <Step>
    ...
    <Button>Exit Impersonation</Button> button at the top.
  </Step>
</Flow>
...
<Flow id="impersonate-user">
  ...
  <Step>
    After impersonation has started, go to <NavStep>Infra Management > Control Plane Clusters</NavStep>.
  </Step>
  <Step>
...
- **[Create Clusters](../../../use-platform/virtual-clusters/create/create-no-template.mdx)**

vCluster Platform allows you to:

- **[Configure sleep mode for clusters](/docs/vcluster/configure/vcluster-yaml/sleep)**
:::
