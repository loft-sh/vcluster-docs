...
Directory, Okta, SAML, etc.), check out the [SSO Group Sync](../sso-group-sync.mdx) section for
more details.
:::
...
- **[Create Virtual Clusters](../../apps/create.mdx)**

vCluster Platform allows you to:

- **[Configure sleep mode for virtual clusters](../../../namespaces/sleep-mode.mdx)**
:::
