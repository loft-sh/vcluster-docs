...
<Flow id="create-user">
  ...
  <Step>
    In the configuration sheet that opens, give your new user a name by
...
- **Image Pull Secrets**: Configure registry credentials that the user automatically receives when logging into vCluster Platform using the CLI
