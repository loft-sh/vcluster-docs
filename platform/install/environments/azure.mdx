...
You can also use Google as an identity provider and [configure SSO](../../configure/platform-configs/single-sign-on/providers/google.mdx) to enable user authentication to the platform.
