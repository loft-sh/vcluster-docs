...
:::info
For more information on how to configure a custom domain, see the [Configure external acess and TLS documentation](/platform/configure/installation-options/domain).
...
You can also use Google as an identity provider and [configure SSO](/platform/configure/platform-configs/single-sign-on/providers/google) to enable user
