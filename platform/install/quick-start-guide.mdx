...
If you need to uninstall the platform, use the following command:
...
:::danger Uninstalling
Uninstalling the platform removes all associated resources, including virtual clusters and their data. Ensure you back up any important data before proceeding with this step.
:::
