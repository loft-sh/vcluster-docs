...
sidebar_label: Deploy using CLI
sidebar_position: 1
...
- Administrator access to a Kubernetes cluster: Your current kube-context must have administrative privileges. See [Accessing Clusters with kubectl](https://kubernetes.io/docs/tasks/tools/#kubectl) for more information.
