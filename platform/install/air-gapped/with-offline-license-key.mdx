...
If you want to run a dedicated offline license service in-cluster, see [With Offline License Server](./with-offline-license-server.mdx). For how the platform decides between these modes, and how it caches and refreshes what it retrieves, see [How licensing works](../../understand/licensing.mdx).
