...
Set `config.loftHost` to the domain where users access the platform. This is required because the vCluster Router cannot auto-provision a domain without internet connectivity.
