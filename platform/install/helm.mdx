...
If you haven't done so, add the vCluster Helm repository and update.
...
`vcluster-platform` chart in the vCluster Labs public repository
...
:::note vCluster Router
vCluster provides a hosted domain for the vCluster platform, referred to as the vCluster Router.
The vCluster Router enables you to trial the vCluster platform using a hosted domain by vCluster. This is particularly useful when you cannot 
...
```bash title="Set the environment variable to disable vCluster Router"
