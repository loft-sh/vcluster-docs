...
a new YAML file containing only the desired values settings. An example values file `values.
...
in the Configuration Section of the docs [here](/platform/install/configure/config.mdx).
