...
Since for simplicity and performance reasons both components are compiled into the same binary in vCluster Platform, scaling of vCluster Platform works a little bit differently than with kubernetes components.
