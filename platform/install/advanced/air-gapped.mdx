...
<Flow id="offline-platform-images">
  ...
  When pushing images into your private registry, the public private registry is removed and only the repository and image name are pushed. 
You can configure the platform to pull all the images it needs from your private registry without engaging with external networks.
