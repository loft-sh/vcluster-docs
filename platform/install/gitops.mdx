...
- **Annotations**: Controllers add tracking annotations like `loft.sh/apply`, `loft.sh/project-namespace`
- **Finalizers**: The `loft.sh/cleanup` finalizer is auto-added to managed resources
...
This tells ArgoCD to ignore any fields managed by the `loft` controller, automatically adapting to field changes without explicit paths.
