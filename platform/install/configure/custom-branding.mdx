...
The vCluster Platform UI can be branded according to your corporate design.

Custom branding can be configured via the [vCluster Platform Config](../../api/resources/config.mdx):
...
If you need even more control, you can use additional javascript and css. The css classes and html ids in the vCluster Platform UI DOM are stable across versions.
You are responsible for making sure your files are accessible to the vCluster Platform UI in the same way you'd expose your logo.
