...
You can add new versions to your App via the vCluster Platform UI.
...
<Flow id="create-app-version">
  ...
  <Step>
    Find the App you would like to add a new version to in the list of Apps.
    Click the small drop down button next to the name of your desired App. From
    the drop down menu, click the <Label>Add A New Version</Label> button.
  </Step>
  <Step>
...
practices for your App versioning. vCluster Platform refers to the version numbers provided when determining
