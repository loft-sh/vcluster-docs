...
import TenantClustersDashboard from '@site/static/media/platform/screenshots/all-tenant-clusters-management-dashboard.png';
import ConnectedClustersDashboard from '@site/static/media/platform/screenshots/host-clusters-management-dashboard.png';
...
<figure className="platform-screenshot">
  <img src={TenantClustersDashboard} alt="Tenant cluster dashboard showing clusters across multiple projects with status, template, sleep, and control plane host columns" />
  <figcaption>The tenant cluster dashboard gives operators one place to review cluster status, project ownership, templates, sleep state, and control plane placement.</figcaption>
</figure>
