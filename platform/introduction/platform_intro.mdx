...
Node providers integrate with cloud APIs (AWS, GCP, Azure, and others) to provision VMs that join as private nodes. For bare metal infrastructure, [vMetal](/docs/platform/vmetal/drivers/bare-metal/overview) handles physical server provisioning using the same model.
