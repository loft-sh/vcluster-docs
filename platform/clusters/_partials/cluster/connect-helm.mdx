...
You can either reuse the CLI Access Key or create a new one by following the [Access Key guide](../../users/advanced/access-keys#create-an-access-key).
...
- Create new Access Key by following the [Access Key](../../users/advanced/access-keys#create-an-access-key) guide.
