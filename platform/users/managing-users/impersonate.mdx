...
import PartialClusterAccessCreateUI from '@site/platform/clusters/_partials/cluster-access/create-ui.mdx'
...
You can also use the vCluster Platform CLI as the impersonated user, to do this, simply run the following
...
Directory, Okta, SAML, etc.), check out the [SSO Group Sync](../managing-teams/sso-group-sync.mdx) section for
more details.
:::
...
- **[Create Virtual Clusters](../../virtual-clusters/using-virtual-clusters/create.mdx)**
