- Ensure that the required network ports are open.
    ...
    :::info  
    The platform requires open ports for API extensions, webhooks, and cost monitoring. In private Kubernetes clusters, ensure firewall rules allow traffic from the Kubernetes master to platform components.  
    :::
