...
Add the following YAML configuration to your platform config (the `config` section of the [`values.yaml`](../../configure/introduction.mdx)) or through vCluster Platform UI **Admin > Config**:
