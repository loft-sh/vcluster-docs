...
You can find more details about the available flags for the `vcluster platform add cluster` command in the [CLI documentation](../../../../vcluster/cli/vcluster_platform_add_cluster).