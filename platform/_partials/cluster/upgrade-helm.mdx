...
If you prefer to use Helm, ensure that you have a valid access key.  
You can only obtain an access key after the cluster has been connected to the Platform.
...
```
In this example, `cluster-name` refers to the host cluster containing the platform agent that you want to upgrade.
