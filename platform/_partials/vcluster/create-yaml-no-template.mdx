...
<Flow id="create-vcluster-form-no-template">
  ...
  <Step>
    Configure your virtual cluster with options in the `values` section. Read more about what values can be used as it is the equivalent of the [vcluster.yaml](../../vcluster/configure/vcluster-yaml/).
  </Step>
  <Step>
