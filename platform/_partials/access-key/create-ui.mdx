...
<Flow id="create-space-template-ui">
  ...
  <Step>
    OPTIONAL: Expand the <Expander>Limit Access Key Scope</Expander> section to specify which control plane clusters, namespaces, and clusters this access key can be used for
  </Step>
  <Step>
    On the very bottom, click the <Button>Create</Button> button to create this access key
  </Step>
</Flow>