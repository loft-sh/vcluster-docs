...
2. The `vcluster platform create vclsuter` command is used to create a unique virtual cluster using information about the pull request in the `default` project. This will automatically configure the kube context for the next steps.
