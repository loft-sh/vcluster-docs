...
* [Metal3](../drivers/bare-metal/metal3.mdx) for bare metal provisioning using Metal3 and Ironic.
...
These node providers, together with any tenant cluster's requests for capacity, make up vMetal, the Machine provisioning and lifecycle layer of vCluster Platform. See [vMetal overview](../overview.mdx) for how they fit together.
...
You can restrict the node types a project's NodeClaims may use with [`spec.allowedNodeTypes`](../../administer/projects/allowed/node-types.mdx).
