...
2. The provider sets the BareMetalHost's `userData` reference to this Secret and the image information from the configured [OSImage](../../images/os-images.mdx) or direct image properties.
