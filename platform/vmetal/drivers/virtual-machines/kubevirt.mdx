...
The `vcluster.com/ssh-keys` and `vcluster.com/user-data` properties behave identically across providers. See the [metal3 reference](../bare-metal/metal3.mdx#ssh-and-user-data) for details.
