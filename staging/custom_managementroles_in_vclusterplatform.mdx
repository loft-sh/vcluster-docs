...
This article provides an overview of **Management roles** and **Custom roles** within the vCluster platform and guides you through creating custom management roles that can be designated as project roles.
...
1. **Login** to the vCluster platform UI.
2. **Navigate to** the **Users** section.
3. Click on the **Management Roles** tab.

## 3. What are Custom Roles in the vCluster Platform?
...
5. To make the role accessible as a **project role**, add the following label:
   ...
   ```
6. Under **Rules**, define the **RBAC policies** to be assigned to the role.
...
3. The custom role should now be available in the **role dropdown** for selection.
