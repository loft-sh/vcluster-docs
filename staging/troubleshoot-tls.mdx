...
```
    ...
    If they don't match, most likely you didn't configure `tls` section in your `vcluster-platform.yaml` values file correctly.  refer to [this guide](./domain.mdx) to learn how to configure custom TLS for vCluster Platform.
