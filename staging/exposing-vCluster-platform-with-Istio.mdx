---
title: Exposing vCluster Platform with Istio
sidebar_label: Exposing vCluster Platform with Istio
description: A simple approach to expose vCluster Platform with Istio
---


Istio can be used to expose vCluster Platform. A simple approach would be to install istio into the platform host cluster with istioctl install. You could then apply manifests for a Gateway and IstioService like the following:
