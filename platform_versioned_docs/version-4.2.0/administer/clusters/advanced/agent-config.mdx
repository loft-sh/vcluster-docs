...
:::warning
If you do not install vCluster Platform agent into a connected cluster at all, certain capability, such as Spaces, Sleep Mode, Apps, Accounts, Account Quotas & Security Templates will not be available in the cluster
:::
