...
Directory, Okta, SAML, etc.), check out the [SSO Group Sync](../../../configure/single-sign-on/group-sync) section for
more details.
:::
...
- **[Create Virtual Clusters](../../../use-platform/virtual-clusters/create/create-no-template)**

vCluster Platform allows you to:

- **[Configure sleep mode for virtual clusters](../../../use-platform/virtual-clusters/key-features/sleep-mode)**
:::
