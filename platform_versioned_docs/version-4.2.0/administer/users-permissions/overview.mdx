...
[Users and Teams](../../understand/what-are-users-and-teams), as well as
[SSO Configuration Options](../../configure/single-sign-on/providers/openid-connect) as building out a complete RBAC design will
...
Check out the [Impersonate](./managing-users/impersonate) docs section for the basics of impersonation.
...
Configuring SSO in vCluster Platform is documented [here](../../configure/single-sign-on/providers/openid-connect), for purposes of this
