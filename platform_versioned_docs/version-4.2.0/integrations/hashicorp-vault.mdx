...
You must update the [vCluster Platform configuration](../api/resources/config) with the Vault object to set up a global Vault integration.
...
For further configuration options, see the [vCluster Platform configuration reference](../api/resources/config) and the [Vault configuration options](#configuration-options).
:::
