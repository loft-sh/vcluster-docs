...
Each virtual cluster that is created in the platform belongs to a [project](../../../understand/what-are-projects). There are two primary ways which
virtual clusters can be created: from a template or manually.

Virtual clusters created from a [template](../../../understand/what-are-templates)
