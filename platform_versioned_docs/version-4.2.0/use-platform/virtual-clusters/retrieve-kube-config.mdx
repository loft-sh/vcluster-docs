...
:::info
If you have direct [cluster endpoints](../../administer/clusters/advanced/multi-region-mode) or
[ingress endpoints for virtual clusters](key-features/ingress-access)
enabled, the resulting kubeconfig will look different.
:::

## Create kubeconfig without the CLI

You can also create a kubeconfig manually by creating an [access key](../../administer/users-permissions/access-keys) for
