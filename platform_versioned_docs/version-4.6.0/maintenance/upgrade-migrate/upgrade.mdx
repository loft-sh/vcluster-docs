...
see [Adding OIDC Clients to vCluster Platform OIDC Using Secrets](/platform/administer/authentication/oidc-provider#adding-oidc-clients-to-vcluster-platform-oidc-using-secrets). The `oidc.clients` field
