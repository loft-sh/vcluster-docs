...
see [Adding OIDC Clients to vCluster Platform OIDC Using Secrets](/docs/platform/administer/authentication/oidc-provider#add-oidc-clients-to-vcluster-platform-oidc-using-secrets). The `oidc.clients` field
