...
<Step>
[Perform a backup of the source platform](/platform/maintenance/backup-restore/backup-restore-platform).
</Step>
...
<Step>
[Restore the backup to the new installation](/platform/maintenance/backup-restore/backup-restore-platform#restore-vcluster-platform-from-backup).
</Step>
