...
- **[Sleep mode](./key-features/sleep-mode.mdx)**: Automatic sleep/wake, to include the vCluster control plane, based on activity to save resources
...
- Configure [sleep mode](./key-features/sleep-mode.mdx) for cost optimization
