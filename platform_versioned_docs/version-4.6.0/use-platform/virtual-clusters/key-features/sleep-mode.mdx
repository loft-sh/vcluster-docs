...
For detailed vCluster-specific sleep mode configuration and examples, see the [vCluster sleep mode documentation](/docs/vcluster/configure/vcluster-yaml/sleep).
