...
:::info
You can easily configure your own [custom domain](../../configure/installation-options/domain.mdx).
:::
...
reasons. You can [reset the administrator password](/docs/platform/administer/authentication/reset-admin-password).
<!-- vale on -->
:::
