...
<Flow id="cluster-connect-helm">
  <Step>
    ...
    [Access Key guide](../../administer/authentication/access-keys.mdx#create-an-access-key).
    ...
    Key](/platform/administer/authentication/access-keys.mdx#create-an-access-key) guide.
  ...
  <Step>
    ...
    This command automatically installs the [vCluster Platform Agent](/docs/platform/4.6.0/administer/clusters/advanced/agent-config) in the cluster that is your current context.
