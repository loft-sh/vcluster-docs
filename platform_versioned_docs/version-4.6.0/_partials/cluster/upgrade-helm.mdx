...
<Flow id="upgrade-cluster-helm">
    ...
    <Step>
        ...
        ```
        In this example, `cluster-name` refers to the host cluster containing the [vCluster Platform Agent](/docs/platform/4.6.0/administer/clusters/advanced/agent-config) to be upgraded.
