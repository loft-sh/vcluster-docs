**Connect to the Platform**: to use any `vcluster platform` command, you need to be connected to the platform. See [authentication documentation](/docs/platform/4.5.0/api/authentication) for more details.
