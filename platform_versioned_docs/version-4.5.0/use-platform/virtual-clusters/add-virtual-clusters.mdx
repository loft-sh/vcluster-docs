...
For conceptual understanding of externally vs. Platform-deployed virtual clusters, see [Externally deployed virtual clusters](/docs/platform/4.5.0/understand/externally-vs-platform-deployed).
:::
...
```
The platform access key can only be provided as a Kubernetes Secret. You can find more information of how to create such Secret at the [`apiKey` configuration section of vCluster.](/docs/vcluster/configure/vcluster-yaml/external/platform/api-key).
...
For [GitOps deployments](/docs/platform/4.5.0/install/gitops), create the [VirtualClusterInstance](../../api/resources/virtualclusterinstance/virtualclusterinstance.mdx) directly in your Git repository. Tools like [Argo CD](/docs/platform/4.5.0/integrations/argocd) or Flux will apply the CRD, and the Platform will manage the virtual cluster:
...
- See [Platform GitOps installation guide](/docs/platform/4.5.0/install/gitops) for complete setup
:::
...
<Flow id="helm-to-platform">
  <Step>
    **Deploy vCluster with Helm**
    ...
    Deploy your vCluster using Helm or your preferred deployment tool. For detailed Platform installation instructions, see the [Platform Helm installation guide](/docs/platform/4.5.0/install/helm).
...
- **[Full lifecycle management](/docs/platform/4.5.0/use-platform/virtual-clusters/manage-access)**: Platform handles upgrades and configuration changes
...
- **[Sleep mode](/docs/platform/4.5.0/use-platform/virtual-clusters/key-features/sleep-mode)**: Automatic sleep/wake, to include the vCluster control plane, based on activity to save resources
- **[Project assignment](/docs/platform/4.5.0/administer/projects/create)**: Organize virtual clusters into projects with quotas
- **[SSO integration](/docs/platform/4.5.0/configure/single-sign-on/overview)**: <GlossaryTerm term="user">User</GlossaryTerm> access through Platform SSO providers
- **[Audit logging](/docs/platform/4.5.0/configure/advanced/audit)**: Centralized audit trails for compliance
- **[Resource quotas](/docs/platform/4.5.0/administer/projects/quotas)**: Enforce resource limits via <GlossaryTerm term="project">project</GlossaryTerm> settings
- **[UI management](./add-virtual-clusters.mdx)**: Full control through Platform UI
- **[Backup/restore](/docs/platform/4.5.0/administer/backup-restore/backup-restore-platform)**: Platform-managed backup policies
...
- Learn about [managing virtual cluster access](/docs/platform/4.5.0/use-platform/virtual-clusters/manage-access)
- Configure [sleep mode](/docs/platform/4.5.0/use-platform/virtual-clusters/key-features/sleep-mode) for cost optimization
- Set up [templates](../../administer/templates/create-templates.mdx) for consistent deployments
- Explore [GitOps integration](/docs/platform/4.5.0/install/gitops) for declarative management
