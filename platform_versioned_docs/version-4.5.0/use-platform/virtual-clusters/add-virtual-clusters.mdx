...
- **[Sleep mode](/docs/platform/use-platform/virtual-clusters/key-features/sleep-mode)**: Automatic sleep/wake, to include the vCluster control plane, based on activity to save resources
- **[Project assignment](/docs/platform/administer/projects/create)**: Organize virtual clusters into projects with quotas
- **[SSO integration](/docs/platform/configure/single-sign-on/overview)**: <GlossaryTerm term="user">User</GlossaryTerm> access through Platform SSO providers
- **[Audit logging](/docs/platform/configure/advanced/audit)**: Centralized audit trails for compliance
...
- **[Backup/restore](/docs/platform/administer/backup-restore/backup-restore-platform)**: Platform-managed backup policies
...
- Configure [sleep mode](/docs/platform/use-platform/virtual-clusters/key-features/sleep-mode) for cost optimization
