...
For more details on how snapshots work, refer to the documentation in the [Snapshot and Restore](/vcluster/manage/backup-restore/backup) section.
...
Check the [Volume Snapshot](/vcluster/manage/backup-restore/backup) documentation page to learn more about getting your cluster ready for snapshotting volumes
:::
