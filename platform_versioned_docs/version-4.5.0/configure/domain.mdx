...
If you want to [configure the platform with additionalCA](config.mdx#using-a-custom-certificate-authority), the Certificate Authority used for signing this certificate has to be added as a base64 encoded value:
...
If you want to [configure the platform with additionalCA](config.mdx#using-a-custom-certificate-authority), use:
