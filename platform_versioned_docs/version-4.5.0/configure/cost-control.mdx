...
config](/docs/platform/4.5.0/configure/cost-control).
...
For individual cluster configuration, the [Cluster](/docs/platform/4.5.0/api/resources/clusters) resource allows for further
