...
Install the platform in the new cluster by following the [quick start guide](/docs/platform/4.5.0/install/quick-start-guide).
...
<Step>
[Perform a backup of the source platform](/docs/platform/4.5.0/administer/backup-restore/backup-restore-platform).
</Step>
...
<Step>
[Restore the backup to the new installation](/docs/platform/4.5.0/administer/backup-restore/backup-restore-platform#restore-vcluster-platform-from-backup).
</Step>
...
<Step>
Update the hostname in the platform configuration as described in the [configuration guide](/docs/platform/4.5.0/configure/config#setting-a-custom-domain).
</Step>
<Step>
