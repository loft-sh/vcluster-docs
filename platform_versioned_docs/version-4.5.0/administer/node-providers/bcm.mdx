...
The BCM node provider can use the [Netris integration](/vcluster/deploy/control-plane/container/environment/bare-metal) for automated network configuration and IP management.
The following properties require the integration to be enabled and [configured](/vcluster/deploy/control-plane/container/environment/bare-metal).
...
For more information on Netris integration, see the [Netris integration documentation](/vcluster/deploy/control-plane/container/environment/bare-metal).
