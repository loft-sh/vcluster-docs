...
You can [create templates](/docs/platform/4.5.0/administer/templates/create-templates) using the vCluster Platform UI for guided configuration or by applying manifests directly with `kubectl`, Helm, or ArgoCD. 
...
- [Parameters](/docs/platform/4.5.0/administer/templates/parameters) - Enable dynamic customization of template fields, allowing users to specify values for CPU limits, labels, environment types, and other configuration options during vCluster provisioning.

- [Versioning](/docs/platform/4.5.0/administer/templates/versioning) - Manage and iterate template configurations across different releases, providing version control for your cluster templates. It allows for automatic updates for virtual clusters based on versioned templates. Templates without versions do not support automatic updates.


## Next steps

- [Create a template](/docs/platform/4.5.0/administer/templates/create-templates) to define a reusable configuration.
- Optionally, [configure template parameters](/docs/platform/4.5.0/administer/templates/parameters) to allow user customization.
- Optionally, [set up template versioning](/docs/platform/4.5.0/administer/templates/versioning) to manage template updates.
