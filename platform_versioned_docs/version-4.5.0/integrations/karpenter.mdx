...
2. vCluster Platform installed on host cluster. Read [Deploy the vCluster Platform docs](https://www.vcluster.com/docs/platform/4.5.0/install/quick-start-guide#2-deploy-the-vcluster-platform).
