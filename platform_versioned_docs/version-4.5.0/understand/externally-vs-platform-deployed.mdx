...
1. [Create a virtual cluster](/docs/platform/4.5.0/use-platform/virtual-clusters/create/create-no-template) in the platform.
2. [Add externally deployed virtual cluster](/docs/platform/4.5.0/use-platform/virtual-clusters/add-virtual-clusters) virtual clusters to the platform.
