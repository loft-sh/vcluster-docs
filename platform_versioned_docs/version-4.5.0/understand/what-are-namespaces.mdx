...
- [Sleep Mode & Auto Delete](../use-platform/namespaces/key-features/sleep-mode.mdx) that puts namespaces to sleep when nobody is using them or delete namespaces that have been
idle for a while.
