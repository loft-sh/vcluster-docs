...
Specifies a cooldown duration in seconds for this access key, overriding the default cooldown period.
...
Associates this access key with a specific shell pod identified by its UID.
...
Indicates that this namespace was created for the browser shell feature and confirms its association.
