...
<!-- vale off -->
Using `helm` values allows you to manage configuration declaratively and enables deployment through [GitOps solutions](../install/gitops.mdx) such as ArgoCD. Here's an example of applying platform configuration with `helm`:
<!-- vale on -->
