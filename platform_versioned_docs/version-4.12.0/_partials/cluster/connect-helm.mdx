...
<Flow id="cluster-connect-helm">
  <Step>
    ...
    Key](../../administer/authentication/access-keys.mdx#create-an-access-key) guide.
  ...
  <Step>
    ...
    This command automatically installs the [vCluster Platform Agent](../../administer/clusters/advanced/agent-config.mdx) in the cluster that is your current context.
