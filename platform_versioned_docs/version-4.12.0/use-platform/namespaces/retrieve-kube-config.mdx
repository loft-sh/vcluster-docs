...
:::info
Depending on if you have regional cluster endpoints enabled, the kubeconfig will look different.
:::

See the [Platform CLI hub](../../reference/platform-cli.mdx) for UI-to-CLI equivalents across common Platform tasks, including namespace commands.
