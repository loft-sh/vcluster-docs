...
The Kubectl Shell feature can be accessed in the Project Overview page under the three-dot menu for any vCluster row. The Kubectl Shell feature can also be accessed on the vCluster
Config page under the three-dot menu.
...
should only be granted to users who would be considered admins for the targeted vCluster. It is common for all users with access to a vCluster to effectively be admins for that vCluster. Pod exec
