...
```bash
kubectl edit argocdapplications.management.loft.sh shared-infra -n p-my-project
```
...
```bash
kubectl patch argocdapplications.management.loft.sh shared-infra -n p-my-project \
        --type json \
