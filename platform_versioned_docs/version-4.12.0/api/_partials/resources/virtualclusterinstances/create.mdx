...
Make sure to set the project in the `metadata.namespace` field you want to create the Virtual Cluster in. If your project has the id `my-project`, the corresponding namespace would be `p-my-project`.
...
curl -s -X POST --insecure \
     "https://$LOFT_DOMAIN/kubernetes/management/apis/management.loft.sh/v1/namespaces/p-my-project/virtualclusterinstances" \
