...
```bash
kubectl edit virtualclusterinstances.management.loft.sh my-virtual-cluster -n p-my-project
```
...
```bash
kubectl patch virtualclusterinstances.management.loft.sh my-virtual-cluster -n p-my-project \
        --type json \
