...
vCluster Platform allows you to configure taking snapshots of the vCluster at specific intervals. For detailed auto snapshot configuration and examples, see the [vCluster auto snapshots documentation](/docs/vcluster/configure/vcluster-yaml/snapshots).
