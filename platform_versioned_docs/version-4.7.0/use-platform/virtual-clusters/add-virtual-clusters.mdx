...
- **[Auto-delete](/docs/vcluster/configure/vcluster-yaml/sleep-mode#configure-auto-delete)**: Automatic cleanup after inactivity periods
- **[Auto Sleep](/docs/vcluster/configure/vcluster-yaml/sleep-mode)**: Automatic sleep/wake, to include the vCluster control plane, based on activity to save resources
...
- Configure [auto sleep](/docs/vcluster/configure/vcluster-yaml/sleep-mode) for cost optimization
