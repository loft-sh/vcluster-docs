...
Policies can be created either through the vCluster Platform UI or through directly creating `JsPolicy` objects in the cluster. For a more extensive documentation how to write policies, please check the [jsPolicy docs](https://www.jspolicy.com/docs/writing-policies/workflow).
