...
For more information on other parameter types, including selection from predefined options, see the [template parameters documentation](../administer/templates/advanced/parameters.mdx).