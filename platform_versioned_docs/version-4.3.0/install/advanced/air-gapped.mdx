...
After you complete the platform setup, stay on this page if you need to complete additional platform configuration.
...
:::info Air-gapped vCluster Guide
The air-gapped deployment guide for individual vClusters is not available in vCluster v0.21.0. Please refer to the platform documentation for managing virtual clusters in air-gapped environments.
:::
