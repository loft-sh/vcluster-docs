...
After you complete the platform setup, stay on this page if you need to complete additional platform configuration or proceed to the vCluster guide for [deploying individual virtual clusters](/vcluster/deploy/control-plane/kubernetes-pod/security/air-gapped):
...
**Use the [vCluster air-gapped deployment guide](/vcluster/deploy/control-plane/kubernetes-pod/security/air-gapped) to:**
