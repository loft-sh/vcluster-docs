...
<details>
<summary>Network prerequisites </summary>

- **Required network ports open** - Ports 8443, 9443, 9444, and 9090 must be accessible for platform communication.
- **Host cluster access to platform domain** - Connected host clusters must reach the domain where vCluster Platform is hosted.

</details>

<details>
<summary>Resource prerequisites</summary>

- **vCluster Platform Pod Resources**:
...
After you complete the platform setup, stay on this page if you need to complete additional platform configuration or proceed to the vCluster guide for deploying individual virtual clusters: 

**Continue with this platform air-gapped guide if you need to:**
- Configure additional platform-wide private registry settings.
- Connect more host cluster agents without internet access.

**Use the [vCluster air-gapped deployment guide](/docs/vcluster/deploy/air-gapped) to:**
- Virtual cluster creation after platform setup.
- Detailed vCluster configuration options for air-gapped environments.
- vCluster-specific deployment procedures and troubleshooting.
