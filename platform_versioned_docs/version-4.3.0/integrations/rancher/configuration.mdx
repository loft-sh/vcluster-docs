...
<Flow id="install-rancher-plugin">
  <Step>
    In the Rancher UI, click the <NavStep>Extensions</NavStep> in the left side menu. Click on the ellipsis menu on the top right and select <Label>Manage Repositories</Label>.
  </Step>
  <Step>
...
<Flow>
  <Step>
     In the left side nav menu, click the <Label>Cluster Management</Label>. Click the on the ellipsis button of the `local` cluster. Select the <Label>Edit Config</Label> option.
  </Step>
  <Step>
    Click on the <Label>Labels & Annotations</Label> row and click <Button>Add Label</Button>. 
  </Step>
  <Step>
