...
| Object | Description |
|--------|-------------|
| **User** | A person with platform access. Users can have Management Roles assigned directly and can belong to Groups and Teams. [API reference](https://www.vcluster.com/docs/platform/4.4.0/api/resources/user) |
| **SSO Group** | A representation of a group from your [configured SSO provider](https://www.vcluster.com/docs/platform/4.4.0/configure/single-sign-on/overview). These groups are imported during authentication and stored in User records. |
| **Team** | A collection of platform users. Users join teams either through explicit assignment or via SSO Group membership. Teams can have Management Roles. [API reference](https://www.vcluster.com/docs/platform/4.4.0/api/resources/team) |
| **Management Role** | Defines permissions granted to users or teams within specific scopes. [API reference](https://www.vcluster.com/docs/platform/4.4.0/api/resources/clusterroletemplate) |
| **Project** | An organizational unit for resources such as virtual clusters. [Projects](https://www.vcluster.com/docs/platform/4.4.0/understand/what-are-projects) help enforce access control and resource quotas.|
...
1. Configure Microsoft Entra ID as your SSO provider using either:
   - [OIDC configuration](https://www.vcluster.com/docs/platform/4.4.0/configure/single-sign-on/providers/microsoft)
   - [SAML configuration](https://www.vcluster.com/docs/platform/4.4.0/configure/single-sign-on/providers/saml)
...
- [Single sign-on configuration](https://www.vcluster.com/docs/platform/4.4.0/configure/single-sign-on/overview)
- [Platform permissions reference](https://www.vcluster.com/docs/platform/4.4.0/administer/users-permissions/permissions/platform)
- [SSO group synchronization](https://www.vcluster.com/docs/platform/4.4.0/configure/single-sign-on/group-sync)