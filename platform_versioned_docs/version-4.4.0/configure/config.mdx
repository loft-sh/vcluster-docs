...
:::info Prerequisite
Before setting a custom certificate authority, you must [configure TLS for the platform](/docs/platform/4.4.0/configure/domain#configure-tls).
:::
...
```
An [access key](/docs/platform/4.4.0/administer/users-permissions/access-keys#how-access-keys-work) is required for authentication.
<br></br>
