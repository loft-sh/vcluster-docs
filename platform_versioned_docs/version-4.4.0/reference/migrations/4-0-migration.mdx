...
see [Adding OIDC Clients to vCluster Platform OIDC Using Secrets](/docs/platform/4.4.0/how-to/oidc-provider#adding-oidc-clients-to-vcluster-platform-oidc-using-secrets). The `oidc.clients` field
