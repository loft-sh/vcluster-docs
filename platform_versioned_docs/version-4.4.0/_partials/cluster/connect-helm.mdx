...
[Access Key guide](../../administer/users-permissions/access-keys#create-an-access-key).
...
Key](/docs/platform/4.4.0/administer/users-permissions/access-keys#create-an-access-key) guide.
