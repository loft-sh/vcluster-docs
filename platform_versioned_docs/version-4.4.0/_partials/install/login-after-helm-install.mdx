...
:::info
You can easily configure your own [custom domain](/docs/platform/4.4.0/configure/domain).
:::
...
reasons. You can [reset the administrator password](/docs/platform/4.4.0/how-to/reset-admin-password).
<!-- vale on -->
:::
