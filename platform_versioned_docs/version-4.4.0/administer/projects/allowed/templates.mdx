...
- Access the host namespace through [Namespace Objects and Namespace Apps](/docs/platform/4.4.0/use-platform/namespaces/key-features/isolation#configure-namespace-objects), which deploy resources directly to the host cluster
