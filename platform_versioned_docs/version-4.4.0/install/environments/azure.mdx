...
:::info
For more information on how to configure a custom domain, see the [Configure external access and TLS documentation](/docs/platform/4.4.0/configure/domain).
:::
...
You can also use Google as an identity provider and [configure SSO](/docs/platform/4.4.0/configure/single-sign-on/providers/google) to enable user authentication to the platform.
