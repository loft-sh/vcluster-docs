...
You can also use Google as an identity provider and [configure SSO](/docs/platform/configure/single-sign-on/providers/google) to enable user authentication to the platform.
