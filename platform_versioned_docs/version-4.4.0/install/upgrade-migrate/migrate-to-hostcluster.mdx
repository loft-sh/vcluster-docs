...
<Step>
[Perform a backup of the source platform](/docs/platform/administer/backup-restore/backup-restore-platform).
</Step>
...
<Step>
[Restore the backup to the new installation](/docs/platform/administer/backup-restore/backup-restore-platform#restore-vcluster-platform-from-backup).
</Step>
...
<Step>
Update the hostname in the platform configuration as described in the [configuration guide](/docs/platform/configure/config#setting-a-custom-domain).
</Step>
<Step>
