...
Project, vCluster, and Space. This approach uses shared OpenTelemetry DaemonSets on the Control Plane Cluster without requiring individual collector installations per tenant cluster.
