...
:::info
If you encounter issues while configuring agent values or deploying it manually, see [Troubleshoot connected cluster connection failures](../../troubleshoot/connected-cluster-connectivity.mdx).
:::
