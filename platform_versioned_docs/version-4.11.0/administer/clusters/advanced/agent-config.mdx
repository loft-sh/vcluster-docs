...
For issues configuring agent values or manual deployment, see [Troubleshoot connected cluster connection failures](../../../troubleshoot/connected-cluster-connectivity.mdx).
