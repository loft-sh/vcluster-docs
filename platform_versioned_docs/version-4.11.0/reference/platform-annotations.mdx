...
**Example:** `loft.sh/argocd-registered-app-name: "my-application"`

**Used on:** ArgoCD application resources

**Set by:** Platform

The ArgoCD application name that was last successfully registered.

### loft.sh/argocd-registered-cluster-name {#loft-sh-argocd-registered-cluster-name}

**Type:** Annotation

**Example:** `loft.sh/argocd-registered-cluster-name: "production-cluster"`

**Used on:** VirtualClusterInstance, Cluster

**Set by:** Platform

The ArgoCD cluster name that was last successfully registered. Used to detect and migrate name changes when a platform license appears and the name gains an instance-ID hash suffix.
