...
1. Install the vCluster CLI.
   ...
   :::warning
   These instructions install the latest released version. To explore the beta features in this guide, install the latest beta version of the CLI. @TODO add instructions 
   :::   
...
1. (Optional) Configure vCluster with `vcluster.yaml`.
   ...
   Refer to the `vcluster.yaml` [reference docs](/vcluster/vcluster-yaml/README.mdx) to explore all configuration options.
