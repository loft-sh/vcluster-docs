...
```bash
vcluster pro connect cluster cluster-name --display-name [display-name]
```
...
```bash
vcluster pro connect cluster cluster-name --display-name [display-name] --context [context]
```
