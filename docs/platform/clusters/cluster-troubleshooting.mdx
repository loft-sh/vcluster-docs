...
If you encounter issues with agent connectivity, you can enable additional debug logs using the following environment variables in the [`vcluster.yaml` file of the Platform Helm chart](../admin/guides/install-with-helm#vclusterpro-configuration).
...
Please ensure that Platform logs are set to debug in the [`vcluster.yaml` file of the Loft Helm chart](../admin/guides/install-with-helm#vclusterpro-configuration); otherwise, the logs won't be shown.
