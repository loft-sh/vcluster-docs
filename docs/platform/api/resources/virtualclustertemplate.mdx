...
import Reference from "@site/docs/platform/api/_partials/resources/virtualclustertemplates/reference.mdx";
import Retrieve from "@site/docs/platform/api/_partials/resources/virtualclustertemplates/retrieve.mdx";
import Create from "@site/docs/platform/api/_partials/resources/virtualclustertemplates/create.mdx";
import Update from "@site/docs/platform/api/_partials/resources/virtualclustertemplates/update.mdx";
import Delete from "@site/docs/platform/api/_partials/resources/virtualclustertemplates/delete.mdx";
