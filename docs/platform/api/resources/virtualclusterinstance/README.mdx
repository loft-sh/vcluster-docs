...
import Reference from "@site/docs/platform/api/_partials/resources/virtualclusterinstances/reference.mdx";
import Retrieve from "@site/docs/platform/api/_partials/resources/virtualclusterinstances/retrieve.mdx";
import Create from "@site/docs/platform/api/_partials/resources/virtualclusterinstances/create.mdx";
import Update from "@site/docs/platform/api/_partials/resources/virtualclusterinstances/update.mdx";
import Delete from "@site/docs/platform/api/_partials/resources/virtualclusterinstances/delete.mdx";
