...
import Reference from "@site/docs/platform/api/_partials/resources/virtualclusterinstances/kubeconfig/reference.mdx";
import SubResourceGet from "@site/docs/platform/api/_partials/resources/virtualclusterinstances/kubeconfig/subresourceget.mdx";
