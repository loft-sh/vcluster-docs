...
import Reference from "@site/docs/platform/api/_partials/resources/projects/migratespaceinstance/reference.mdx";
import SubResourceCreate from "@site/docs/platform/api/_partials/resources/projects/migratespaceinstance/subresourcecreate.mdx";
