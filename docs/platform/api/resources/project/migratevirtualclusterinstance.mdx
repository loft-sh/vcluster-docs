...
import Reference from "@site/docs/platform/api/_partials/resources/projects/migratevirtualclusterinstance/reference.mdx";
import SubResourceCreate from "@site/docs/platform/api/_partials/resources/projects/migratevirtualclusterinstance/subresourcecreate.mdx";
