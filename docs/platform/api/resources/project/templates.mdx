...
import Reference from "@site/docs/platform/api/_partials/resources/projects/templates/reference.mdx";
import SubResourceGet from "@site/docs/platform/api/_partials/resources/projects/templates/subresourceget.mdx";
