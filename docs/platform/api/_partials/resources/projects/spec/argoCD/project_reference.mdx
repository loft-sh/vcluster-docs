...
Metadata defines additional metadata to attach to the vCluster.Pro created project in ArgoCD.
...
no vCluster.Pro default roles will be set. If no roles are provided _and_ SSO is enabled, vCluster.Pro will
