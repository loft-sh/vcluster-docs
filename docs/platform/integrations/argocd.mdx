...
vCluster.Pro provides several points of integration with [Argo CD](https://argo-cd.readthedocs.io/en/stable/),
...
in the Argo CD UI. When the virtual clusters are deleted, vCluster.Pro will automatically remove the
...
will configure Argo CD to allow users to authenticate via vCluster.Pro. After enabling this setting
users who browse to the Argo CD instance will see a button to login via vCluster.Pro. All members of the
project will be able to log in via vCluster.Pro and gain access to Argo CD.

The final integration level is the App Project/Argo CD Project integration. This tier configures
an App Project in Argo CD that corresponds to the vCluster.Pro project. This option allows for
...
Configuration of each of these integration modes all starts at the vCluster.Pro project object. Argo CD
...
>
  <TabItem value="creation">
    <Flow id="enable-argocd-project-creation">
      ...
      <Step>
        ...
        </Label> dropdown. This tells vCluster.Pro if your Argo CD instance lives
  ...
  <TabItem value="existing">
    <Flow id="enable-argocd-project-existing">
      ...
      <Step>
        From the project drop-down menu, select the project you'd like to enable
        Argo CD integration on.
      </Step>
      <Step>Click the Project Settings option on the project pane.</Step>
      <Step>
...
of the vCluster.Pro project to log in to Argo CD via vCluster.Pro.

:::info Pre-Requisites
The `loftHost` vCluster.Pro configuration must be set to enable this integration. The `loftHost` can be
  ...
  <TabItem value="creation">
    <Flow id="enable-argocd-sso-project-creation">
      ...
      <Step>
        ...
        vCluster.Pro) URL of your Argo CD instance.
      </Step>
      <Step>
        <b>[Optional]</b> select the desired RBAC role to assign to project
        members who log into Argo CD via vCluster.Pro.
      </Step>
      <Step>
        Finish configuring anything else you'd like on your project, then click
        the
  ...
  <TabItem value="creation">
    <Flow id="enable-argocd-import-creation">
      ...
      <Step>
        ...
        the Argo CD enabled virtual cluster in.
      </Step>
      <Step>
