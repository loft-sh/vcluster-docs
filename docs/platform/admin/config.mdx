...
The vCluster Platform config allows you to modify vCluster Platform's behaviour and enable or disable certain features, such as [SSO login](../users/openid-connect.mdx), [custom branding](../admin/guides/custom-branding.mdx) or [auditing](../admin/audit.mdx).
