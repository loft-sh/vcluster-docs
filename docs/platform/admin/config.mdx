...
When using helm you can apply the vCluster.Pro config via a `vcluster.yaml` file. This also makes it possible to deploy vCluster.Pro through GitOps solutions such as ArgoCD. An example vCluster.Pro `vcluster.yaml` could look like this:
