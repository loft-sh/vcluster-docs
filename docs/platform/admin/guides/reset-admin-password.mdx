...
To reenable password login you need to edit the vCluster.Pro configuration.
...
Make sure to restart your vCluster.Pro pods afterwards for the new configuration to take effect.
:::
...
After that you should be able to login with the user `admin` and your new password into vCluster.Pro