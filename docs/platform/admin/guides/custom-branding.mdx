...
Custom branding can be configured via the [vCluster.Pro Config](../../api/resources/config.mdx):
...
If you need even more control, you can use additional javascript and css. The css classes and html ids in the vCluster.Pro UI DOM are stable across versions.
You are responsible for making sure your files are accessible to the vCluster.Pro UI in the same way you'd expose your logo.
