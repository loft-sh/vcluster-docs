...
Project Secret. Once created, vCluster.Pro will handle synchronizing the project secret data to your secret.
...
inefficient to watch secrets in all virtual clusters, vCluster.Pro will instead synchronize virtual cluster secrets on an
interval.
:::

## Project Secret synced from Global Secret

When you have a global secret defined in vCluster.Pro and wish to use it inside your project, you can configure syncing
