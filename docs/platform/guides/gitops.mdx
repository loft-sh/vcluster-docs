---
title: "GitOps And vCluster Platform"
sidebar_label: "GitOps And vCluster Platform"
...
Before continuing, you should take a look at the [installation with helm ](/platform/admin/guides/install-with-helm.mdx)
...
If you have disabled agent installation on your vCluster Platform deployment as outlined in the Helm
installation guide [here](/platform/admin/guides/install-with-helm.mdx#the-vclusterpro-agent), you will need to ensure
...
out the [API documentation](/platform/api/resources/project/README.mdx) where you can find example manifests and
