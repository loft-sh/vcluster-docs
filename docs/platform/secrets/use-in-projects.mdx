...
When you have a shared secret defined in vCluster.Pro and wish to use it inside your project, you can configure syncing between a project secret and the shared secret.
