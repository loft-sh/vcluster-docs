...
You must update the [vCluster.Pro configuration](../api/resources/config.mdx) with the Vault object to set up a global Vault integration.
...
For further configuration options, see the [vCluster.Pro configuration reference](../api/resources/config.mdx) and the [Vault configuration options](#configuration-options).
:::
...
You need to update the [project specification](../api/resources/project/project.mdx) with the Vault object to set up a project-based Vault integration.
...
For further configuration options, see the [Project reference](../api/resources/project/project.mdx) and the [Vault configuration options](#configuration-options).
:::
