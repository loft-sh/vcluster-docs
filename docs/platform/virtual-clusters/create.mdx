...
Each virtual cluster that is created in vCluster.Pro belongs to a Project. There are two primary ways which
virtual clusters can be created inside vCluster.Pro: from a template, and manually.
...
Project owners and vCluster.Pro admins can create virtual clusters manually, that is without a template.

## Create From Template

Project members can create a new virtual cluster through the vCluster.Pro UI or CLI:
...
Regardless of how you create a virtual cluster from a template, either by the UI or the CLI, vCluster.Pro
