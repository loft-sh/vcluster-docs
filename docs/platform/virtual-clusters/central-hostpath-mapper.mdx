...
:::info Pre-Requisites
This feature requires the Central Hostpath Mapper to be present in the host cluster. It is available as a default vCluster.Pro App under the Apps Section. Make sure to install it beforehand for all the features to work correctly.
:::
