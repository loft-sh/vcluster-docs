...
import PartialVirtualClusterCreateCLI from "@site/docs/platform/virtual-clusters/_partials/vcluster/create-cli.mdx";
import PartialVirtualClusterCreateUI from "@site/docs/platform/virtual-clusters/_partials/vcluster/create-ui.mdx";
import PartialVirtualClusterCreateOptionalTemplateUI from "@site/docs/platform/virtual-clusters/_partials/vcluster/create-ui-optional-fields-template.mdx";
...
mechanism for vCluster.Pro administrators to expose acceptable virtual cluster configurations to end users.
...
- Custom defined [Apps](/platform/apps/README.mdx)

## Create Virtual Cluster Template

Virtual cluster templates can be created directly in the vCluster.Pro UI.

<Flow id="create-vcluster-template-ui">
  <Step>
    In the vCluster.Pro UI, select the <NavStep>Templates</NavStep> field on the
    left-most menu bar.
  </Step>
...
You can add new versions to your virtual cluster templates via the vCluster.Pro UI.
...
You can change the virtual cluster template or virtual cluster template version in the vCluster.Pro UI.
...
When deploying a virtual cluster referring to a template with parameters configured, vCluster.Pro will
