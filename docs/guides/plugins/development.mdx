...
You can deploy your plugin to a vCluster using the same commands as [described on the overview page](/guides/plugins/overview.mdx#loading-and-installing-plugins-to-vcluster), for example, with the vCluster CLI.
```
