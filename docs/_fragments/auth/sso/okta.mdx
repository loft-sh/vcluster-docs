...
<figure class="frame">
  <img
    src={require("@site/static/media/v1/ui/auth/create-app-okta.png").default}
...
<figure class="frame">
  <img
    src={require("@site/static/media/v1/ui/auth/okta-select-web.png").default}
    alt="Create App for vCluster Platform"
  />
  <figcaption>
...
<figure class="frame">
  <img src={require("@site/static/media/v1/ui/auth/okta-app-settings.png").default} alt="Create App for vCluster Platform" />
...
<figure class="frame">
  <img
    src={require("@site/static/media/v1/ui/auth/okta-refresh-token.png").default}
    alt="Create App for vCluster Platform"
  />
...
<figure class="frame">
  <img
    src={require("@site/static/media/v1/ui/auth/okta-group-filter.png").default}
...
<figure class="frame">
  <img
    src={require("@site/static/media/v1/ui/auth/okta-client-secret.png").default}
    alt="Create App for vCluster Platform"
  />
...
<figure class="frame">
  <img
    src={require("@site/static/media/v1/ui/auth/okta-loft-config.png").default}
    alt="Okta Assign Peoples"
  />
...
<figure class="frame">
  <img
    src={require("@site/static/media/v1/ui/auth/okta-assign-people.png").default}
    alt="Okta Assign Peoples"
  />
...
<figure class="frame">
  <img src={require("@site/static/media/v1/ui/auth/okta-loft-login.png").default} alt="Okta Assign Peoples" />
