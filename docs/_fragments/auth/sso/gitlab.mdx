...
- Application name: vCluster.Pro Login via GitLab
...
**Create vCluster.Pro Config For GitLab**

To tell vCluster.Pro to use gitlab for SSO, navigate to `Admin > Config` in vCluster.Pro and adjust your config as shown below:
