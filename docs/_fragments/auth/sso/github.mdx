...
- Application name: vCluster.Pro Login via GitHub
- Homepage URL: https://vcluster-pro.yourcompany.tld = `https:// + $VCLUSTER_PRO_HOSTNAME`
- Auth callback URL: https://vcluster-pro.yourcompany.tld/auth/github/callback = `https:// + $VCLUSTER_PRO_HOSTNAME + /auth/github/callback`
...
**Create vCluster.Pro Config For GitHub**

To tell vCluster.Pro to use github for SSO, navigate to `Admin > Config` in vCluster.Pro and adjust your config as shown below:
