...
The SAML 2.0 connector in vCluster.Pro does **not** support refresh tokens "since the SAML 2.0 protocol doesn't provide a way to requery a provider without interaction" (see [dex documentation for SAML 2.0](https://dexidp.io/docs/connectors/saml/)).
:::
...
To tell vCluster.Pro to use SAML for SSO, navigate to `Admin > Config` in vCluster.Pro and adjust your config as shown below:
