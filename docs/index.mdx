...
<div style={{marginBottom: '3rem'}}>
  <p style={{fontSize: '1rem', color: 'var(--ifm-color-content-secondary)', marginBottom: '1.5rem'}}>
    Two questions determine where to start. Do you already have a Kubernetes cluster, or are you starting from scratch? And will tenant workloads run on shared or dedicated nodes?
  </p>
  <table style={{width: '100%', borderCollapse: 'collapse', marginBottom: '1rem'}}>
    <thead>
      <tr>
        <th style={{padding: '0.75rem 1rem', textAlign: 'left', borderBottom: '2px solid var(--ifm-color-emphasis-300)'}}></th>
        <th style={{padding: '0.75rem 1rem', textAlign: 'left', borderBottom: '2px solid var(--ifm-color-emphasis-300)'}}>Shared nodes</th>
        <th style={{padding: '0.75rem 1rem', textAlign: 'left', borderBottom: '2px solid var(--ifm-color-emphasis-300)'}}>Private nodes</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td style={{padding: '0.75rem 1rem', borderBottom: '1px solid var(--ifm-color-emphasis-200)', fontWeight: '600'}}>Existing Kubernetes cluster</td>
        <td style={{padding: '0.75rem 1rem', borderBottom: '1px solid var(--ifm-color-emphasis-200)'}}><a href="/docs/vcluster/deploy/control-plane/kubernetes-pod/basics">Get started →</a></td>
        <td style={{padding: '0.75rem 1rem', borderBottom: '1px solid var(--ifm-color-emphasis-200)'}}><a href="/docs/vcluster/deploy/worker-nodes/private-nodes/">Get started →</a></td>
      </tr>
      <tr>
        <td style={{padding: '0.75rem 1rem', borderBottom: '1px solid var(--ifm-color-emphasis-200)', fontWeight: '600'}}>vCluster Standalone (no existing cluster)</td>
        <td style={{padding: '0.75rem 1rem', borderBottom: '1px solid var(--ifm-color-emphasis-200)'}}><a href="/docs/vcluster/deploy/control-plane/binary/basics">Get started →</a></td>
        <td style={{padding: '0.75rem 1rem', borderBottom: '1px solid var(--ifm-color-emphasis-200)'}}><a href="/docs/vcluster/deploy/control-plane/binary/basics">Get started →</a></td>
      </tr>
      <tr>
        <td style={{padding: '0.75rem 1rem', fontWeight: '600'}}>vind — Docker, no Kubernetes needed</td>
        <td style={{padding: '0.75rem 1rem', color: 'var(--ifm-color-content-secondary)'}}>—</td>
        <td style={{padding: '0.75rem 1rem'}}><a href="/docs/vcluster/deploy/control-plane/docker-container/basics">Get started →</a></td>
      </tr>
    </tbody>
  </table>
  <p style={{fontSize: '0.9rem', color: 'var(--ifm-color-content-secondary)'}}>Not sure which path fits? <a href="/docs/vcluster/introduction/what-are-virtual-clusters">Read the overview</a> to understand the tradeoffs.</p>
</div>
...
<div style={{marginBottom: '3rem'}}>
  ...
  <div style={{marginBottom: '2.5rem', borderLeft: '4px solid #0C00FF', paddingLeft: '1.5rem'}}>
    <div style={{marginBottom: '1.5rem'}}>
      ...
      <span style={{fontSize: '1.05rem', color: 'var(--ifm-color-content-secondary)'}}>
        Strong workload isolation using Linux user namespaces.
      </span>
    </div>
    <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.25rem'}}>
