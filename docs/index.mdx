...
<div style={{marginBottom: '3rem'}}>
  <div style={{marginBottom: '2.5rem', borderLeft: '4px solid #ff5733', paddingLeft: '1.5rem'}}>
    ...
    <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.25rem'}}>
      <Link to="/docs/vcluster/" className="card feature-card" style={{padding: '0.75rem 1rem'}}>
        <h3 style={{margin: 0, fontSize: '1.1rem'}}>Get Started</h3>
        <p style={{margin: '0.25rem 0 0 0', fontSize: '0.9rem', color: 'var(--ifm-color-content-secondary)'}}>Quick start guide to create your first virtual cluster.</p>
      </Link>
      <Link to="/docs/vcluster/configure/what-is-vcluster-yaml" className="card feature-card" style={{padding: '0.75rem 1rem'}}>
  ...
  <div style={{marginBottom: '2.5rem', borderLeft: '4px solid #ff5733', paddingLeft: '1.5rem'}}>
    ...
    <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.25rem'}}>
      <Link to="/docs/platform" className="card feature-card" style={{padding: '0.75rem 1rem'}}>
        <h3 style={{margin: 0, fontSize: '1.1rem'}}>Get Started</h3>
...
<div style={{marginTop: '4rem', marginBottom: '3rem'}}>
  <h2 style={{marginBottom: '2rem'}}>vCluster Architecture</h2>
  
  <div className="intro-card">
    <figure style={{margin: 0, textAlign: 'center'}}>
      <img
        src={require('@site/static/media/rebranding/vcluster-architecture.png').default}
        alt="vCluster Architecture - Virtual Clusters in Host Cluster"
        style={{
          width: '100%',
          maxWidth: '1000px',
          height: 'auto',
      ...
      <figcaption style={{
        ...
        Virtual clusters run as pods in the host cluster, with their own control plane and isolated resources
      </figcaption>
    </figure>
  </div>
</div>
