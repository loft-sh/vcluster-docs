...
<div className="intro-card">
  ...
  <div style={{fontSize: '1.1rem', lineHeight: '1.6', marginBottom: '1.5rem'}}>
    vCluster is a production-grade Kubernetes platform that allows AI clouds and enterprises to provision and manage tenant clusters with hyperscaler-grade control plane isolation and reliability. Its virtualized control plane is completely invisible to tenants, leaving no control plane nodes and no in-cluster agent pods. Every tenant receives a clean, isolated cluster experience while simplifying operations for the provider. Full infrastructure isolation, the model for customer-facing Kubernetes offerings, requires [private nodes](/docs/vcluster/deploy/worker-nodes/private-nodes).
  </div>
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.25rem', marginBottom: '3rem'}}>
  <Link to="/vcluster/production-guide/overview" className="audience-card">
    ...
    <h3>Plan a production platform</h3>
    <span className="card-desc">Deliver dedicated tenant clusters over GPU infrastructure. Start with the worker node decision, then move to production architecture.</span>
  </Link>
...
<div style={{marginBottom: '3rem'}}>
  <div style={{marginBottom: '2.5rem', borderLeft: '1px solid #ff6600', paddingLeft: '1.5rem'}}>
  ...
  <div style={{marginBottom: '2.5rem', borderLeft: '1px solid #0C00FF', paddingLeft: '1.5rem'}}>
    <div style={{marginBottom: '1.5rem'}}>
  ...
  <div style={{marginBottom: '2.5rem', borderLeft: '1px solid #00B7D6', paddingLeft: '1.5rem'}}>
    <div style={{marginBottom: '1.5rem'}}>
