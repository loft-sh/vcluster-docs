...
<div style={{marginBottom: '3rem'}}>
  <div style={{marginBottom: '2.5rem', borderLeft: '4px solid #ff5733', paddingLeft: '1.5rem'}}>
    ...
    <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.25rem'}}>
      <Link to="/vcluster/0.20.0/introduction/what-are-virtual-clusters" className="card feature-card" style={{padding: '0.75rem 1rem'}}>
      ...
      <Link to="/vcluster/0.20.0/configure/what-is-vcluster-yaml" className="card feature-card" style={{padding: '0.75rem 1rem'}}>
      ...
      <Link to="/vcluster/0.20.0/deploy/basics" className="card feature-card" style={{padding: '0.75rem 1rem'}}>
