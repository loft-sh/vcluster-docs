...
Since the vCluster's syncer synchronizes pods to the underlying host cluster to schedule them, vCluster users can use the storage classes of the underlying host cluster to create persistent volume claims and to mount persistent volumes. By default, you can use the host's storage classes without the need to create it in the virtual cluster. 
...
- [Configure storage sync from the host cluster to the virtual cluster](/vcluster-yaml/sync/from-host/storage-classes.mdx).

Sync from virtual to host:

- [Configure persistent volumes](/vcluster-yaml/sync/to-host/storage/persistent-volumes.mdx).
- [Configure persistent volume claims](/vcluster-yaml/sync/to-host/storage/persistent-volume-claims.mdx).
- [Configure storage classes](/vcluster-yaml/sync/to-host/storage/storage-classes.mdx).
- [Configure volume snapshots](/vcluster-yaml/sync/to-host/storage/volume-snapshots.mdx).
