...
import DefaultImageRegistry from '@site/docs/_partials/config/controlPlane/advanced/defaultImageRegistry.mdx'
...
To use your private registry, you need to [configure `imagePullSecrets`](/vcluster/vcluster-yaml/control-plane/deployment/advanced/service-account.mdx).
