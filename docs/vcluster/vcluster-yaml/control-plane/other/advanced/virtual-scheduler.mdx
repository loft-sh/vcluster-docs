...
<br/>
:::info
If you also enable [syncing PersistentVolumeClaim resources](/docs/vcluster/vluster-yaml/sync/to-host/storage/persistent-volume-claims.mdx), vCluster mirrors relevant CSIStorageCapacity, CSINode, and CSIDriver resources to the virtual cluster so the scheduler can make storage-aware scheduling decisions.
:::
