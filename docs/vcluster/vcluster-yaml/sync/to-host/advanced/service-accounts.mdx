...
import EnableSwitch from '@site/docs/_partials/config/sync/toHost/serviceAccounts.mdx'
...
By default, this is disabled. Sync [ServiceAccount](https://kubernetes.io/docs/concepts/security/service-accounts/) resources from the virtual cluster to the host cluster. 
