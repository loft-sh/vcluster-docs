...
*/}
By default, this is enabled. Sync [Secret](https://kubernetes.io/docs/concepts/configuration/secret/) resources used by pods from the virtual cluster to the host cluster. Apps frequently need secret data to function.
