...
By default, this is enabled. Sync all [Pod](https://kubernetes.io/docs/concepts/workloads/pods/) resources, including ephemeral containers, from the virtual cluster to the host cluster.
