...
By default, this is disabled. Sync [VolumeSnapshot](https://kubernetes.io/docs/concepts/storage/volume-snapshots/) resources from the virtual cluster to the host cluster.
