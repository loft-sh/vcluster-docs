...
Services can also be mapped between [different virtual clusters](/docs/vcluster/vcluster-yaml/networking/resolve-dns.mdx). This is achieved through DNS configurations that direct service requests from one virtual cluster to another.
