...
- [Network policies](https://kubernetes.io/docs/concepts/services-networking/network-policies/) like [network isolation](/guides/security/network-isolation).
  - [Network policies](/architecture/networking#network-policies)
- [Admission webhooks](https://kubernetes.io/docs/reference/access-authn-authz/extensible-admission-controllers/#admission-webhooks)
  - [Central Admission Control](/vcluster-yaml/policies/admission-control.mdx)
...
[Isolated Mode](/guides/security/isolated-mode) is a predefined set of policies provided for convenience. This is not the same as the Isolated Control Plane PRO feature.
