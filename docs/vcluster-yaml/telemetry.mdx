...
@TODO this has fields that aren't documented in the current vCluster docs, which only mention how to disable telemetry. This should the EnableSwitch partial - confirm with Fabian
