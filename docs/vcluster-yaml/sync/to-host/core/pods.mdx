...
By default, vCluster syncs all [Pods](https://kubernetes.io/docs/concepts/workloads/pods/), including ephemeral containers from the virtual cluster to the host cluster.
