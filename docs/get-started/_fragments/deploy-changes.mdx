...
You can apply vCluster config changes by editing the `vcluster.yaml` file and running `terraform plan`:
...
<TabItem value="argo">
config file, but you may use any of the options for passing values covered by the
