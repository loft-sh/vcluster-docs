...
By default, within the virtual cluster you only see [fake nodes](/architecture/nodes.mdx) that have different names and a made-up spec rather than the real nodes from the underlying host cluster.
