...
import InstallCLIFragment from '../_fragments/install/cli.mdx'
...
1. [How to deploy vCluster](./02-deployment.mdx).
1. [How to connect to vCluster and how vCluster interacts with the host cluster](./03-connect.mdx). 
