...
\* Due to the number of breaking changes from vCluster v0.19 to v0.20 and vCluster Platform v3.4 to v4.0, v3.4 has an extended EOS end date. Review the [migration guide](/docs/platform/reference/migrations/4-0-migration) to upgrade your platform from v3.4 to v4.0.
