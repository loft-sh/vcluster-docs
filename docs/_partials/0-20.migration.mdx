...
:::note reminder
The Kubernetes distribution of the virtual cluster doesn't need to match the distribution of your control plane cluster. You can use any distribution of vCluster to deploy vCluster on EKS clusters.
:::
