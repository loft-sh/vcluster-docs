...
the Pro image repository. This allows users to seamlessly test and adopt any Enterprise feature without disrupting their existing
open source features. Enterprise features are integrated into the Pro image but remain inactive by default to ensure that your experience remains consistent with the open source version unless you specifically activate them with a vCluster Platform Enterprise plan.
