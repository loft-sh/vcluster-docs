...
\* Due to the number of breaking changes from v0.19 to v0.20, v0.19 has an extended active support end date. Review the [migration guide](/vcluster/reference/migrations/0-20-migration) to upgrade your v0.19 virtual clusters to v0.20.
