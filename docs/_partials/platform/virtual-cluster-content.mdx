...
clusters, allowing users to provision clusters in any vCluster Platform managed cluster (or tenant
cluster!). vCluster Platform also offers the capability to import existing clusters such that they
...
Clusters also provide more stability than namespaces in many situations. The tenant
