...
import VirtualClusterKubeConfig from '../../../_partials/config/experimental/virtualClusterKubeConfig.mdx'
import TenancySupport from '../../../_fragments/tenancy-support.mdx';

:::warning Deprecation notice
Support for **virtualClusterKubeConfig** is deprecated and will be removed in 0.29.0.
:::
