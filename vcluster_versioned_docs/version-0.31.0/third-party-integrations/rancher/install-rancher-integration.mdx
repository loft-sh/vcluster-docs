...
### Network policies
If you are using [network policies](/vcluster/configure/vcluster-yaml/policies/network-policy), Rancher Operator traffic into the virtual cluster control plane must be allowed.
