...
Before deploying vCluster, you must [create an access key](/docs/vcluster/configure/vcluster-yaml/platform) to authenticate your virtual cluster. This step is essential for connecting your air-gapped vCluster to the platform.
