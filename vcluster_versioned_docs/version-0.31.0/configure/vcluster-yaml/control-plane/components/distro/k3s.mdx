...
:::warning
After deploying your vCluster, changing the Kubernetes distribution is not supported, with one exception: starting with vCluster 0.25.0, migration from K3s to K8s distro is supported. For more details, see the [K3s to K8s migration guide](../../../../../deploy/upgrade/distro-migration.mdx).
:::
