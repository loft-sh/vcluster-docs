...
For more information about configuring vCluster and installing the Central HostPath Mapper, see  [Central HostPath Mapper](/platform/maintenance/monitoring/central-hostpath-mapper) in the platform documentation.
