...
##### `tag` <span className="config-field-required" data-required="false"></span> <span className="config-field-type">string</span> <span className="config-field-default">3.6.4-0</span> <span className="config-field-enum"></span> {#deploy-statefulSet-image-tag}
