...
##### `tag` <span className="config-field-required" data-required="false"></span> <span className="config-field-type">string</span> <span className="config-field-default">v1.35.0</span> <span className="config-field-enum"></span> {#distro-k8s-image-tag}
