...
You cannot change distros once a tenant cluster is deployed, with one exception: starting with vCluster 0.25.0, migration from K3s to K8s distro is supported. For more details, see the [K3s to K8s migration guide](/vcluster/manage/upgrade/distro-migration).
:::
