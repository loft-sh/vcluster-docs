...
| Troubleshoot incidents | [vCluster troubleshoot](../troubleshoot/noexec-emptydir-volumes.mdx), [debug commands](../cli/vcluster_debug.md), [Platform troubleshooting](/platform/troubleshoot/connected-cluster-connectivity#enable-verbose-agent-and-platform-logs) |
