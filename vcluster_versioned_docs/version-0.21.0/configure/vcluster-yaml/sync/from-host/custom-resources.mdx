...
If you are looking to sync resources from the vCluster to the host cluster, see [syncing custom resources to the host cluster](/vcluster/configure/vcluster-yaml/sync/to-host/advanced/custom-resources)
