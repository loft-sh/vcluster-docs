...
capability to it. For more advanced capabilities,  consider using the custom resource sync ([fromHost](../sync/from-host/custom-resources), [toHost](../sync/to-host/advanced/custom-resources)) 
