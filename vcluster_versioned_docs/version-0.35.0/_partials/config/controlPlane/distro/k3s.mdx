...
#### `tag` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default">v1.35.0-k3s1</span> <span className="config-field-enum"></span> {#k3s-image-tag}
