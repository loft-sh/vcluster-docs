...
Exposing vCluster is different, depending on whether the control-plane is deployed [as container](../deploy/control-plane/container/basics or [as a binary](../deploy/control-plane/binary/basics.
