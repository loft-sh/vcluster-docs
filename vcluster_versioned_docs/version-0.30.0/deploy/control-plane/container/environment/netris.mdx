...
For more details on kube-vip configuration, see [Kube-vip](/vcluster/next/configure/vcluster-yaml/control-plane/other/advanced/kube-vip).
            ...
            - name: dgx-pool
              ...
              nodeTypeSelector:
                - property: vcluster.com/node-type
                  value: dgx-node
          properties:
            bcm.vcluster.com/network-name: netris-nodes
...
4. Verify node provisioning
    ...
    p-default   netris-8gnqh   Available   netris-pepsi   bcm-netris.dgx-node   2025-10-27T19:39:45Z
    ```
