...
The Netris integration enables vCluster to use [Netris](https://www.netris.io/) for network automation for the vCluster control plane and [private nodes](../../deploy/worker-nodes/private-nodes/README.
...
- BCM Node Provider with Netris
- KubeVirt Node Provider with Netris
