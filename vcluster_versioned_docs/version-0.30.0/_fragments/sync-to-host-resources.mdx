...
* [Pods](../configure/vcluster-yaml/sync/to-host/core/pods/README
* [Secrets](../configure/vcluster-yaml/sync/to-host/core/secrets
* [ConfigMaps](../configure/vcluster-yaml/sync/to-host/core/config-maps
* [Services](../configure/vcluster-yaml/sync/to-host/networking/services
* [Endpoints](../configure/vcluster-yaml/sync/to-host/networking/endpoints
* [PersistentVolumeClaims](../configure/vcluster-yaml/sync/to-host/storage/persistent-volume-claims

### Disabled by default

The following resources are **not** synced by default. You can explicitly enable them in your `vcluster.yaml` configuration.

* [CustomResources](../configure/vcluster-yaml/sync/to-host/advanced/custom-resources
* [Ingresses](../configure/vcluster-yaml/sync/to-host/networking/ingresses
* [NetworkPolicies](../configure/vcluster-yaml/sync/to-host/networking/network-policies
* [PersistentVolumes](../configure/vcluster-yaml/sync/to-host/storage/persistent-volumes
* [VolumeSnapshots](../configure/vcluster-yaml/sync/to-host/storage/volume-snapshots
* [StorageClasses](../configure/vcluster-yaml/sync/to-host/storage/storage-classes
* [ServiceAccounts](../configure/vcluster-yaml/sync/to-host/advanced/service-accounts
* [PodDisruptionBudgets](../configure/vcluster-yaml/sync/to-host/advanced/pod-disruption-budgets
* [PriorityClasses](../configure/vcluster-yaml/sync/to-host/advanced/priority-classes
* [Custom Resources](../configure/vcluster-yaml/sync/to-host/advanced/custom-resources
* [Namespaces](../configure/vcluster-yaml/sync/to-host/advanced/namespaces
