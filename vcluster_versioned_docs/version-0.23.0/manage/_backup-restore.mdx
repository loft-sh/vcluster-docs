...
:::info
Currently the vCluster CLI backup method does not support backing up persistent volumes. If you require that  take a look at the velero backup method below.
:::
