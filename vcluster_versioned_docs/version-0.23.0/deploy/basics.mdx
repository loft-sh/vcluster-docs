...
1. A `vcluster.yaml` is provided. Refer to the `vcluster.yaml` [reference docs](../configure/vcluster-yaml/) to explore all configuration options. Note: This file is optional and can be removed from the examples.
