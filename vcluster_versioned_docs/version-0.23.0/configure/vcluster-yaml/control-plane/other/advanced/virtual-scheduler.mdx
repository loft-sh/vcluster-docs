...
- [CSI nodes](/vcluster/configure/vcluster-yaml/sync/from-host/csi-nodes)
...
<br/>
:::info
If you also enable [syncing PersistentVolumeClaim resources](../../../sync/to-host/storage/persistent-volume-claims), vCluster mirrors relevant CSIStorageCapacity, CSINode, and CSIDriver resources to the virtual cluster so the scheduler can make storage-aware scheduling decisions.
:::
