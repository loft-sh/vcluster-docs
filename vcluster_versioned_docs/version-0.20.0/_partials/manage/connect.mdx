...
import SecretKubeconfig  from '../../_fragments/quickstart/secret-kubeconfig.mdx'
...
<TabItem value="helm">
If you can't use the vCluster CLI, retrieve the vCluster kubeconfig from a secret that is created automatically in the namespace that the vCluster is deployed in.
