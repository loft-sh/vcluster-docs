...
:::info
This example continues from the [Istio integration example](../vcluster-yaml/integrations/istio.mdx).
:::

<Flow id="sleepmode-ingress-example">
  <Step>
    Complete the [Istio integration example](../vcluster-yaml/integrations/istio.mdx).
  </Step>
