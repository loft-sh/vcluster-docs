...
If you have a manually provisioned standalone cluster - you use the [`vcluster platform connect vcluster`](../../../cli/vcluster_platform_connect_vcluster) command to attach it to the platform for management.
