...
|:---------------------------------------------------|:------:|:------:|:---------------:|:------:|
| [Control plane security configuration](./control-plane-components) |  45 |   0  |  14  |  0  |
| [etcd node configuration](./etcd)                  |   7    |   0    |        0        |  0  |
| [Control plane configuration](./control-plane)     |   1    |   4    |        0        |  0  |
| [Worker node security configuration](./worker-node)|   0    |   0    |       24        |  0  |
| [Kubernetes Policies](./policies)                  |   9    |  24    |        0        |  2  |
