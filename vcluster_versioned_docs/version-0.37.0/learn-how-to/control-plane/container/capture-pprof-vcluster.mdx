...
:::note
You must be on the kube-context of the control plane cluster where the vCluster is running. 
:::
...
This command allows you to access services running inside the tenant cluster from your local machine without exposing them publicly through the control plane cluster’s services or ingress.
