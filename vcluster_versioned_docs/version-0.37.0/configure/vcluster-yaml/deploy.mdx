...
This field requires vCluster Platform. The Platform UI hides the Stacks form for vCluster versions that don't support it. See [Use a Stack](/docs/platform/next/use-platform/apps/use-stacks) for the user workflow and status model.
