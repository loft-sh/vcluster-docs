...
With vCluster Platform 4.12, use a [Stack](/docs/platform/next/understand/what-are-stacks) when separate Apps or Argo CD Applications need explicit ordering. Stack tasks can wait for healthy dependencies and pass outputs to later tasks. See [Create a Stack template](/docs/platform/next/administer/templates/create-stack-templates).
