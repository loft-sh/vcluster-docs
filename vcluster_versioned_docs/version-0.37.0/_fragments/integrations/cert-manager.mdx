...
Create or update a tenant cluster following the [vCluster quick start guide](/vcluster/quick-start/shared-nodes).
Configure cluster contexts to simplify switching between control plane and tenant clusters:
...
<Highlight color="secondary">Tenant Cluster</Highlight> Create a self-signed issuer
...
<Highlight color="secondary">Tenant Cluster</Highlight> Create a certificate
...
<Highlight color="secondary">Tenant Cluster</Highlight> Issue certificates from your CA
...
```bash title="Apply certificate in tenant cluster"
...
<Highlight color="secondary">Tenant Cluster</Highlight> Create an ACME issuer
...
<Highlight color="secondary">Tenant Cluster</Highlight> Create an ACME certificate
...
<Highlight color="secondary">Tenant Cluster</Highlight> Check certificate status
...
<Highlight color="secondary">Tenant Cluster</Highlight> Verify secret creation
