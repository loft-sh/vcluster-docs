...
When several applications make up the GPU environment, use a [Stack](/docs/platform/next/understand/what-are-stacks) to deploy them repeatedly with dependency ordering and health gates. See [Create a Stack template](/docs/platform/next/administer/templates/create-stack-templates) to package GPU operators, schedulers, monitoring, and dependent applications.
