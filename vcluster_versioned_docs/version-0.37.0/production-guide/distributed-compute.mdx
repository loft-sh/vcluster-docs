...
| Standardize tenant GPU software | [Stacks](/docs/platform/next/understand/what-are-stacks), [create a Stack template](/docs/platform/next/administer/templates/create-stack-templates) | If you manage tenant software, define one ordered application baseline that can be deployed consistently across compute sources. |
...
9. If you manage the tenant software layer, [create a StackTemplate](/docs/platform/next/administer/templates/create-stack-templates) for the GPU applications that should be consistent across sites, then [deploy it to the tenant environments](/docs/platform/next/use-platform/apps/use-stacks#choose-how-to-install-a-stack).
