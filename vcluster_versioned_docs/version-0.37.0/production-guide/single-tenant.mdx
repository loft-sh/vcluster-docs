...
| Define the customer application baseline | [Stacks](/docs/platform/next/understand/what-are-stacks), [create a Stack template](/docs/platform/next/administer/templates/create-stack-templates) | If every customer receives the same multi-application baseline, define its Apps or Argo CD Applications, dependencies, and health gates once. |
...
8. If customers receive a standard application baseline, [create a StackTemplate](/docs/platform/next/administer/templates/create-stack-templates) and [include it in the tenant cluster configuration](/docs/platform/next/use-platform/apps/use-stacks#choose-how-to-install-a-stack).
