...
import CertManagerConfig from '!!raw-loader!../../../experimental/_code/cert-manager-config.yaml'
...
You can modify the sync behavior with patches that target specific paths. Currently there is 2 different kinds of patches supported.
