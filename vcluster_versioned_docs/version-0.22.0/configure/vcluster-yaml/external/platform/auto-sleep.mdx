...
The virtual cluster can be scheduled to sleep and wake up in the `vcluster.yaml`, but to use this ability, the vCluster also will need to be connected to the platform.
