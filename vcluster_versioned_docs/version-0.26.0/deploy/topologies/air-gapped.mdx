...
:::note
You must have the vCluster Platform deployed in your air-gapped environment to use this guide. To prepare your environment for air-gapped deployment, see the [platform air-gapped installation guide](/docs/platform/install/advanced/air-gapped).
:::
...
For more details on FIPS, refer to the [FIPS configuration guide](/docs/vcluster/deploy/security/fips).
