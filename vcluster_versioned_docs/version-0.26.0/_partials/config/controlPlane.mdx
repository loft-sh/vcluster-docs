...
##### `tag` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default">3.5.25-0</span> <span className="config-field-enum"></span> {#controlPlane-backingStore-etcd-deploy-statefulSet-image-tag}
