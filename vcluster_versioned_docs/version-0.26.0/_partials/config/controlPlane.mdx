...
##### `tag` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default">v1.32.8</span> <span className="config-field-enum"></span> {#controlPlane-distro-k8s-image-tag}
...
##### `tag` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default">v1.32.7-k3s1</span> <span className="config-field-enum"></span> {#controlPlane-distro-k3s-image-tag}
