...
- Configure `sleepMode` with [specific labels](/docs/vcluster/configure/vcluster-yaml/sleep-mode?x3=1#sleepMode-autoSleep-exclude-selector-labels) to define which resources should remain active. This allows targeting specific resources based on their labels.
