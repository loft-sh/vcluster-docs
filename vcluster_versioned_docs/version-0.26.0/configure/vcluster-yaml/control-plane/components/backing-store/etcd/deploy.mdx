...
There is an option to migrate from a deployed etcd to the [embedded](/docs/vcluster/configure/vcluster-yaml/control-plane/components/backing-store/etcd/embedded) etcd option. Replace your current backing store with this option and upgrade your virtual cluster.
