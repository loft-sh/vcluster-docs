...
:::warning
Before attempting any recovery procedure, [create a backup](../../../../../../manage/backup-restore.mdx) of your virtual cluster using `vcluster snapshot create --include-volumes`. This ensures both the virtual cluster's etcd data and persistent volumes are backed up.
...
For detailed snapshot creation instructions, see [Snapshot and restore](../../../../../../manage/backup-restore.mdx).
:::
...
See [Snapshot and restore](../../../../../../manage/backup-restore.mdx) for authentication details.
:::
</Step>
