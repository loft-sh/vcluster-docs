...
To connect a virtual cluster to the vCluster Platform, you can use an API key—referred to as an access key in the platform's console. There are two authentication methods:
