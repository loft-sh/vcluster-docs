...
/>
    ...
    Each user can connect to the virtual cluster by using their personal access key through the vCluster CLI.

    Log in to the platform:

  <!-- vale off -->
<InterpolatedCodeBlock
  code={`vcluster platform login [[VAR:PLATFORM URL:YOUR_PLATFORM_URL]] --access-key [[VAR:ACCESS KEY:YOUR_PERSONAL_ACCESS_KEY]]
  language="bash"
...
<br />
  ...
  Then, connect the virtual cluster using the following command:
