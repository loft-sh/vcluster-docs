...
You can connect to [vCluster Platform](/platform/) through the `vcluster.yaml` and configure different vCluster Platform settings that work with the virtual cluster.
