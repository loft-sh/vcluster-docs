...
Virtual cluster internal logging relies on a separate component called the [HostPath Mapper](/platform/administer/monitoring/central-hostpath-mapper). This component resolves the virtual pod and container names to their physical counterparts.
