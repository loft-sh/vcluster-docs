...
### Network policies
If you are using [network policies](/vcluster/configure/vcluster-yaml/policies/network-policy), private nodes traffic into the virtual cluster control plane must be allowed.
