...
Tenant cluster internal logging uses a separate component called the [HostPath Mapper](/docs/platform/maintenance/logging/central-hostpath-mapper). This component matches virtual pod and container names to their real physical names.
