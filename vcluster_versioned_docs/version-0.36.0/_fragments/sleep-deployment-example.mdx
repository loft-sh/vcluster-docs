...
<Flow id="sleepmode-deployment-example" title="Auto sleep deployment example" description="This example demonstrates how to configure and manage auto sleep functionality in tenant clusters without using an agent.">
...
Create demo deployments in your tenant cluster.
