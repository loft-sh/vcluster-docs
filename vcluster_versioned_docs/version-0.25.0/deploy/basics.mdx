...
- A `vcluster.yaml` is provided. Refer to the `vcluster.yaml` [reference docs](../configure/vcluster-yaml/README) to explore all configuration options. This file is optional and can be removed from the examples.
