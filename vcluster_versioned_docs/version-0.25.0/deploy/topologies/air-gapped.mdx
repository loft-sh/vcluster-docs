...
- vCluster Platform deployed in your air-gapped environment. See the [platform air-gapped installation guide](/platform/install/advanced/air-gapped) for instructions.
...
Before deploying vCluster, you need to create an access key in the platform to authenticate your virtual cluster. Follow the instructions in the [API key configuration guide](/vcluster/configure/vcluster-yaml/external/platform/api-key) to:
