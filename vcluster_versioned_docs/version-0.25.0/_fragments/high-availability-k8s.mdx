...
In order to run vCluster in high availability mode, create a `vcluster.yaml` in the following form:
...
You can find more about rootless mode [here](../security/rootless-mode).
