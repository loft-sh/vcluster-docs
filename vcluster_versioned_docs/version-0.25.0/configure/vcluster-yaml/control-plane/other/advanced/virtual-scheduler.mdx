...
If you also [sync PersistentVolumeClaim resources](../../../sync/to-host/storage/persistent-volume-claims), vCluster mirrors the related `CSIDriver`, `CSINode`, and `CSIStorageCapacity` objects into the virtual cluster. This allows the virtual scheduler to make storage-aware scheduling decisions.
...
- [CSI drivers](../../../sync/from-host/csi-drivers)
- [CSI nodes](../../..//sync/from-host/csi-nodes)
- [CSI storage capacities](../../../sync/from-host/csi-storage-capacities)
...
:::info
If you [sync PersistentVolumeClaim resources](../../../sync/to-host/storage/persistent-volume-claims), vCluster mirrors the related `CSIDriver`, `CSINode`, and `CSIStorageCapacity` objects into the virtual cluster. This allows the virtual scheduler to make storage-aware scheduling decisions.
:::
...
- [Sync `persistentVolumeClaims`](../../../sync/to-host/storage/persistent-volume-claims)
- [Sync `csiStorageCapacities`](../../../sync/from-host/csi-storage-capacities)
- [Sync `csiNodes`](../../../sync/from-host/csi-nodes)
- [Sync `csiDrivers`](../../../sync/from-host/csi-drivers)
