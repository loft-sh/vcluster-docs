...
For Platform users needing project-level network boundaries, combine `policies.networkPolicy` with [VirtualClusterTemplates](/platform/4.3.0/administer/templates/create-virtual-cluster-template):
