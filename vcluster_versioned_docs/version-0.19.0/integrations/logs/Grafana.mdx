---
title: Logging with Loki and Grafana
sidebar_label: Grafana and Prometheus/Loki
sidebar_position: 2
---
...
### Add the Helm repo and install Loki:
You can download sample values file from here : [loki_values.yaml](https://github.com/kirillyesikov/vcluster-docs/blob/main/vcluster_versioned_docs/version-0.19.0/integrations/loki_values.yaml)

```bash
helm repo add grafana https://grafana.github.io/helm-charts
helm upgrade --install loki -f loki_values.yaml --namespace=monitor grafana/loki-stack --create-namespace
```
