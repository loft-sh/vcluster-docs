---
title: "vcluster platform list teams --help"
sidebar_label: vcluster platform list teams
---


Lists the vCluster platform teams you are member of

## Synopsis

```
vcluster platform list teams [flags]
```
