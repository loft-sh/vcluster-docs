    ...
    steps:
      ...
      - name: Deploy Preview Environment
        run: |
          ...
          vcluster create loft-preview-${{ github.event.pull_request.number }} --project preview --recreate
...
jobs:
  destroy:
    ...
    steps:
      ...
      - name: Destroy Preview Environment
        run: |
          vcluster delete loft-preview-${{ github.event.pull_request.number }} --project preview
```
