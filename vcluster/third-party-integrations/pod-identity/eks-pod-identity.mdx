...
This KSA needs to be available in the <GlossaryTerm term="control-plane-cluster">control plane cluster</GlossaryTerm> in which your vCluster instance runs.
...
[access-key-link]: /docs/platform/administer/authentication/access-keys
