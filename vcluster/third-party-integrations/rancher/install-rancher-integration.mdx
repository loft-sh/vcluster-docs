...
<Step title="Register the vCluster chart repository">
...
If the vCluster chart repository is not available in the target cluster, Rancher prompts you to add it:
