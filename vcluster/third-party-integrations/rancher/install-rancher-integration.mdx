...
- A Rancher instance installed in a cluster. The Docker installation method is not supported for production use. Rancher refers to this cluster as the **local cluster**.
