...
Since virtual clusters share physical nodes with the host cluster, Rancher may count virtual cluster nodes toward your resource usage. To prevent this, use sync patches to zero out the CPU capacity reported by the virtual cluster's nodes.
