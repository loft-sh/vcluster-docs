...
Both root causes only trigger when the tenant cluster runs Kubernetes 1.33 or earlier and the <GlossaryTerm term="control-plane">control plane</GlossaryTerm> cluster runs Kubernetes 1.34 or later. See the [Kubernetes compatibility matrix](/docs/vcluster/next/operate/upgrade/supported_versions#kubernetes-compatibility-matrix) for the specific version combinations flagged with this known issue.
...
- [Kubernetes compatibility matrix](/docs/vcluster/next/operate/upgrade/supported_versions#kubernetes-compatibility-matrix)
