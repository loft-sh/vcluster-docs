...
| `upgrade_rejected` | A connection upgrade verb was rejected. See [Connection upgrades return 501](../operate/troubleshoot/resource-proxy.mdx#connection-upgrades). | `request_terminations_total` |
