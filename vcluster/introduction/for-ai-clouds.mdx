---
title: vCluster for AI Cloud Providers
sidebar_label: For AI Cloud Providers
sidebar_position: 3
...
Virtual Nodes add a strong isolation boundary between tenant workloads at the node level using [vNode](https://www.vnode.com/docs/). Each tenant gets its own view of the node environment, with scheduling boundaries enforced per tenant.
