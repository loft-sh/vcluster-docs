...
As a Pro feature, [CoreDNS can be embedded](../configure/vcluster-yaml/control-plane/components/coredns.mdx) directly into the control plane pod, reducing the per-tenant footprint.
