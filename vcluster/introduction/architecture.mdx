...
This model suits internal, trusted tenants such as development environments, CI/CD pipelines, testing, and internal platforms. Because tenants share the same kernel and physical nodes, shared nodes aren't suitable for externally facing or resold tenant offerings. Use private nodes for untrusted or external tenants.
