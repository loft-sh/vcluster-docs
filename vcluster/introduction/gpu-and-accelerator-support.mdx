...
Review [GPU and device isolation](../design/security/shared-nodes-hardening.mdx#gpu-and-device-isolation) for the tenant-isolation gaps specific to shared GPU nodes.
