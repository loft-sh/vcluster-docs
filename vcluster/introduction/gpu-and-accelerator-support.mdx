...
For that layer, see [GPU presentation modes in vMetal](/docs/platform/next/vmetal/concepts/gpu-presentation-modes).
...
For GPU bare metal provisioning and OS image guidance, see [vMetal GPU Quickstart](/docs/platform/next/vmetal/drivers/bare-metal/metal3/gpu-quickstart).
