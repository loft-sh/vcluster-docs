...
- [AI Factory Reference Architecture](./ai-factory-reference-architecture.mdx) — full stack reference covering bare metal, networking, storage, observability, and identity for AI cloud deployments
