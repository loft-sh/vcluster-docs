...
**Shared nodes** — tenant workloads run on the Control Plane Cluster's existing node pool. Multiple tenant clusters share the same physical nodes. Lower overhead, fastest to set up. Suited for developer environments, CI/CD, and high-density internal platforms.
