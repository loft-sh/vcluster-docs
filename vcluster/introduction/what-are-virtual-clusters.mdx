...
<img
  ...
  alt="vCluster Architecture for Shared Nodes"
 />
...
<img
  ...
  alt="vCluster Architecture for Dedicated Nodes"
 />
...
<img
  ...
  alt="vCluster Architecture for Virtual Nodes"
 />
  <figcaption>vCluster Architecture for Virtual Nodes</figcaption>
</figure>


### Private Nodes
* The control plane of the virtual cluster is deployed as a container on a host cluster. 
* Worker nodes of the virtual cluster are individual nodes that are not connected to any other Kubernetes cluster. You can either join manually provisioned nodes to a vCluster or can configure vCluster
...
<img
  ...
  alt="vCluster Architecture for Private Nodes"
 />
  <figcaption>vCluster Architecture for Private Nodes</figcaption>
</figure>
