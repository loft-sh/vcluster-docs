...
<!--
  ...
  This table shows all OSS features (7) + Free tier features (1).
  Features are automatically sorted alphabetically.
-->
<FeatureTable names="virtual-clusters,resource-syncing,pod-security-standards,network-policies,resource-quotas,limit-ranges,metrics-server,platform-integration" />
