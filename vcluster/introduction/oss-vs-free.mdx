...
- **Temporary connectivity issues**: The tenant cluster continues operating from its cached feature list, which is stored in a Secret in the host namespace and stays valid for 7 days.
