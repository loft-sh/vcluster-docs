...
**vCluster Open Source** is the foundation of the project. It provides full-stack tenant isolation with dedicated Kubernetes control planes, resource syncing, and multiple backing stores. OSS requires no license and no Platform connectivity.
