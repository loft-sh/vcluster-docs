...
-->
<FeatureTable names="virtual-clusters,resource-syncing,pod-security-standards,network-policies,resource-quotas,limit-ranges,metrics-server,platform-integration,embedded-etcd,private-nodes,auto-nodes,host-path-mapper,custom-resource-syncing,sync-patches,namespace-syncing,custom-dns" />
...
Beyond the Free tier, vCluster offers an Enterprise tier for production and compliance use cases:

| Feature category | OSS | Free | Enterprise |
|-----------------|-----|------|------------|
| Core features | ✓ | ✓ | ✓ |
