...
- Logs a warning but allows existing vClusters to continue operating
...
**For new vClusters**, create them through the Platform UI or CLI - Free tier features are automatically enabled.
...
```bash
# List vClusters managed by Platform
