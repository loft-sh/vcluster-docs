...
**vCluster Free tier** adds capabilities on top of OSS at no cost, including embedded etcd, Private Nodes, custom resource syncing, sync patches, HostPath Mapper, and high availability. The Free tier requires connecting to the vCluster Platform for license validation but needs no credit card.
...
The following table lists all features and the plans they apply to. Features not listed in any tier are part of the open source distribution and available to everyone.
