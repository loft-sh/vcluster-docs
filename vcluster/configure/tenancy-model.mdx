...
* **[Binary](./vcluster-yaml/control-plane/components/standalone)** - The control plane is deployed as a binary on individual nodes.
* **[Docker Container](./vcluster-yaml/experimental/docker)** - The control plane runs in Docker containers without requiring a host Kubernetes cluster.
...
- **[Docker Deployment](./vcluster-yaml/experimental/docker)** - Both control plane and worker nodes run as Docker containers on the local machine or any Docker-enabled environment. This provides complete isolation and is ideal for development, testing, and CI/CD scenarios.
...
## Feature availability by tenancy model

import FeatureTable from '@site/src/components/FeatureTable';

Understanding which vCluster features are available for your chosen tenancy model helps you plan your deployment architecture.

### Shared host nodes

<FeatureTable tenancy="shared" />
...
<FeatureTable tenancy="standalone" />
