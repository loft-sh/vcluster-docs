...
* **[Private Nodes](./vcluster-yaml/private-nodes)** - Enable joining either manually provisioned nodes or automatic provisioned nodes based on resource requirements to the virtual cluster. 
