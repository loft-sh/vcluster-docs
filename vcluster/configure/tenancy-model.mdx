...
* **[Private Nodes](./vcluster-yaml/private-nodes)** - Enable joining either manually provisioned nodes that need to be joined outside of vCluster, or automatically provision and join nodes by vCluster and vCluster Platform. 
...
| Ability to automatically provision and join nodes  | No | Yes |