...
- **Individual Nodes**: Choose to use individual nodes that are not connected to any other Kubernetes cluster. These nodes can either be manually provisioned outside of vCluster
