...
- **Backing store selection**: Choose between different storage backends for the vCluster control plane's [backing store](./vcluster-yaml/control-plane/components/backing-store/overview.mdx). Options include embedded databases, managed etcd or external databases.
