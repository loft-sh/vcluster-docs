...
- **Individual Nodes**: Choose to use individual nodes that are not connected to any other Kubernetes cluster. You can either join manually provisioned nodes to a vCluster or can configure vCluster
