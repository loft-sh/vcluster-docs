...
The documentation on this page describes sleep mode for a vCluster without an agent, where workloads are scaled down, but the control plane remains active to monitor for activity that should wake it up.
