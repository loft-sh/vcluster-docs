...
<Flow id="sleep-automatic-ui">
  <Step>
    Click on <NavStep>Virtual Clusters</NavStep> to find the virtual cluster that you want to configure automatic sleep mode for.
  </Step>
  <Step>
...
<Flow id="sleep-automatic-constraint-schedule-ui">
  <Step>
    In the <NavStep>Virtual Clusters</NavStep> view, hover over the virtual cluster that you want to configure automatic sleep mode for.
  </Step>
  <Step>
...
You can configure sleep for a virtual cluster by setting the sleep configuration in the VirtualClusterInstance manifest.
