...
### Upgrade
Starting with version v0.30, newly introduced workloads and pods require additional resources. When auto node is enabled, 
the vCluster will automatically provision more nodes to meet the increased resource demands.
