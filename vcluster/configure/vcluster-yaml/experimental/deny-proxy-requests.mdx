...
description: Configure vCluster to deny certain requests in the vCluster proxy.
---
import CodeBlock from '@theme/CodeBlock';
import DenyProxyRequestExample from '!!raw-loader!@site/vcluster/configure/vcluster-yaml/experimental/_code/deny-proxy-config.yaml'
...
<FeatureTable names="deny-proxy-requests" />
