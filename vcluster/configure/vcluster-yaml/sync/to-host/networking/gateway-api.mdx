...
For deeper recipes (including how to recover from each event), see [Gateway API sync troubleshooting](../../../../../operate/troubleshoot/gateway-api-sync.mdx).
