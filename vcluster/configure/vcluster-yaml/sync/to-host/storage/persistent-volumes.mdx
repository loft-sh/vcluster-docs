...
import EnableSwitch from '@site/vcluster/_partials/config/sync/toHost/persistentVolumes.mdx'
...
## Translate Patches
<TranslatePatches resource="persistentVolumes" path="metadata.annotations[*]" />
