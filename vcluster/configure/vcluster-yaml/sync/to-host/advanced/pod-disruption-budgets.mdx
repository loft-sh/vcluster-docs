...
import PodDisruptionBudget from '@site/vcluster/_partials/config/sync/toHost/podDisruptionBudgets.mdx'
...
<TranslatePatches resource="podDisruptionBudgets" path="metadata.annotations[*]" />
