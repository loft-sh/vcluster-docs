...
When using features such as [syncing custom resources](./custom-resources.mdx), adding all used references can become tedious, and rewriting certain references can become very difficult.
...
The following example demonstrates how user and team identity mappings to cluster roles work in practice in a virtual cluster.
