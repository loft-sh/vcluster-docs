...
However, when using features such as [syncing custom resources](./custom-resources.mdx), it can be tedious to add all used references, or it can become very difficult or even impossible to rewrite certain references.
