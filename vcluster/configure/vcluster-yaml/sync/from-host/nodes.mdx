...
By default, when syncing nodes from the control plane cluster, labels, and taints are only synced from the control plane cluster to the cluster. No changes from the tenant 
