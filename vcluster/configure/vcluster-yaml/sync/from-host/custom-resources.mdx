...
By default, vCluster does not require you to specify an API version when syncing custom resources. If a CRD has multiple versions and no version is defined, vCluster uses the storage version.
