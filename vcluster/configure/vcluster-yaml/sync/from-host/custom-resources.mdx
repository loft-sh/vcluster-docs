...
description: Configuration for custom resources
---
...
To use a specific version of a CustomResourceDefinition (CRD), include the version before the resource type in the configuration, separated by a `/`.
