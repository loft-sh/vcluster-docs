...
If you need to sync resources from the tenant cluster to the control plane cluster instead, see [syncing custom resources to the control plane cluster](../to-host/advanced/custom-resources.mdx). For help choosing a direction, and for lifecycle and troubleshooting guidance, see [Manage custom resources](../../../../operate/custom-resources.mdx).
