...
| --- | --- |
| Pro feature license error | Confirm the tenant cluster uses the Pro image and has a license from vCluster Platform. See [Resolve Pro feature license errors](../../../../operate/troubleshoot/pro-feature-license-error.mdx). |
