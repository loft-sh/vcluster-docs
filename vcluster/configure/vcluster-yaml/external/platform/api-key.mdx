...
- **Individual user access keys**: Create separate Kubernetes Secrets, each with a unique personal access key, for every virtual cluster. This method provides granular access control and allows revocation of access to individual clusters.
...
<Tabs>
  ...
  - The vCluster CLI installed on your local machine.
  ...
  <Flow>
    ...
    To connect to the virtual cluster using individual access, each user must:
      ...
      2. Navigate to your **Profile** and click **Access Keys**.
      ...
      :::note
      To view your generated access keys, navigate to **Profile** > **Access Keys**.
      :::
...
<Tabs>
  ...
  <TabItem value="individual" label="Individual user access">
    ...
    external:
      platform:
        userBased: true # Enable individual user access; each user must authenticate with their own personal access key.
    ```
