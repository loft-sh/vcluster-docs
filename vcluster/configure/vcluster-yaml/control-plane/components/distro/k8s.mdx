...
By default, <GlossaryTerm term="vcluster">vCluster</GlossaryTerm> uses an embedded SQLite as the [backing store](../backing-store/overview.mdx) when you use the <GlossaryTerm term="k8s">K8s</GlossaryTerm> distribution.
