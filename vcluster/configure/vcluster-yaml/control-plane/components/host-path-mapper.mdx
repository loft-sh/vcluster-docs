...
Tenant cluster internal logging uses a separate component called the [HostPath Mapper](/docs/platform/next/maintenance/logging/central-hostpath-mapper). This component matches virtual pod and container names to their real physical names.
...
For more information about configuring vCluster and installing the Central HostPath Mapper, see [Central HostPath Mapper](/docs/platform/next/maintenance/logging/central-hostpath-mapper) in the platform documentation.
