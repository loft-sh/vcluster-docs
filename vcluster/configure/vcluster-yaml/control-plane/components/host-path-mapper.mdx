...
Each release of the HostPathMapper tracks a specific vCluster version, with which it is fully-compatible. Before installation,  refer the release notes of your intended HPM version to verify compatibility with your vCluster setup.
:::
