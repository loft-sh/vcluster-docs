...
Only a certain migration paths are supported based on the starting backing store. Please review the options to understand your migration options before deploying your virtual cluster. 
