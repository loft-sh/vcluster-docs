...
There is an option to migrate from a deployed etcd to the embedded *Please add the embedded link** etcd option. Replace your current backing store with this option and upgrade your virtual cluster.
