...
When the majority of etcd member replicas become corrupted or deleted simultaneously (such as 2 of 3, 3 of 5, or 4 of 7 replicas, etc.), the entire cluster requires recovery from backup.
...
Restore PVCs from your backup solution (Velero, CSI snapshots, and similar tools)
Ensure the restored PVCs have the correct names and labels
