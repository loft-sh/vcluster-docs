...
- Replace `vcluster-name` with your actual vCluster `StatefulSet` name (for example `my-vcluster`).
- Replace `namespace` with the namespace where your vCluster is deployed (for example `vcluster-my-team`).
...
- Replace `vcluster-label` with your actual vCluster pod label selector (for example `app=vcluster` or `release=my-vcluster`).
- Replace `namespace` with the namespace where your vCluster is deployed (for example `vcluster-my-team`).
</Step>
...
- Replace `pvc-prefix` with your actual PVC prefix used by the `StatefulSet` (commonly `data` for etcd storage or `vcluster-data`).
- Replace `vcluster-name` with your actual vCluster `StatefulSet` name (for example `my-vcluster`).
- Replace `namespace` with the namespace where your vCluster is deployed (for example `vcluster-my-team`).
...
- Replace `vcluster-label` with your actual vCluster pod label selector (for example `app=vcluster`).
- Replace `namespace` with the namespace where your vCluster is deployed (for example `vcluster-my-team`).
