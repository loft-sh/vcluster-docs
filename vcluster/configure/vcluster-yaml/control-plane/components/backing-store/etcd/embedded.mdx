...
- **Migration from deployed etcd**: Migrates from [deployed etcd](../../../../../../operate/migrate-etcd-backing-store.mdx) to embedded etcd using the `migrateFromDeployedEtcd` flag. vCluster doesn't support changing to other backing store types, including through snapshot and restore.
...
:::warning
Before attempting any recovery procedure, [create a backup](../../../../../../operate/backup-restore/backup.mdx) of your tenant cluster using `vcluster snapshot create`.
...
For detailed snapshot creation instructions, see [Create snapshots](../../../../../../operate/backup-restore/backup.mdx).
:::
...
See [Create snapshots](../../../../../../operate/backup-restore/backup.mdx) for authentication details.
:::
</Step>
