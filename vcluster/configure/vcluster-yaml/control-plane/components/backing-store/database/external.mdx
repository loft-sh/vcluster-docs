...
*connector*: Assign a name of a [connector secret](/docs/platform/administer/connector/database) that exists in an instance of vCluster platform in the installed namespace. vCluster Platform will use the secret to automatically
...
Admin must first setup a [database connector secret](/docs/platform/administer/connector/database) in vCluster Platform. Your vCluster must have access to the vCluster Platform.
