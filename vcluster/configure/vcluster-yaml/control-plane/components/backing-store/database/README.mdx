...
- [Embedded](/vcluster/configure/vcluster-yaml/control-plane/components/backing-store/database/sqlite): The database is deployed inside the cluster control plane.

- [External](/vcluster/configure/vcluster-yaml/control-plane/components/backing-store/database/external): The database runs outside the cluster control plane. You can either:
