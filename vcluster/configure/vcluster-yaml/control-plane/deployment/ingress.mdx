...
The upstream ingress-nginx project is deprecated. Existing ingress-based configurations continue to work in vCluster v0.35 and vCluster Platform v4.10, but Gateway API is recommended for new endpoint deployments. See [Gateway API](../../../../key-features/gateway-api.mdx) and [Migrate from ingress-nginx to Gateway API](../../../../operate/ingress-nginx-to-gateway-api.mdx).
:::
