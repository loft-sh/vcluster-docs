...
The vCluster project provides several configuration options pertaining to cluster
isolation and security. This section briefly covers the primary configuration options. For detailed
information, see the [security overview](../security/README.mdx) and [policies configuration](../configure/vcluster-yaml/policies/README.mdx).
...
Enable these settings in your cluster or cluster template values:
...
CNI supports when investigating cluster isolation.
:::
