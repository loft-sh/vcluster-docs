...
vCluster Platform allows you to configure taking snapshots of the vCluster at specific intervals. see For detailed vCluster-specific auto snapshots configuration and examples, see the [vCluster auto snapshots documentation](../configure/vcluster-yaml/snapshots).
