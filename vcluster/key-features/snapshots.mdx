...
After enabling automatic snapshots, you can view the list of snapshots for each cluster in the details of the cluster. This menu is only available for Project admins and Platform admins users.
