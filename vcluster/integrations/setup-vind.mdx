...
- **Full vCluster configuration** - the cluster supports any [vCluster configuration](../configure/vcluster-yaml/overview.mdx), including multi-node setups and VPN-based private nodes.
