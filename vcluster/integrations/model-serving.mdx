...
- PodDisruptionBudget and graceful termination for draining traffic
...
In production, terminate TLS and enforce customer authentication in your provider traffic layer, API gateway, service mesh, or runtime sidecar. Do not expose unauthenticated model endpoints directly to the public internet.
