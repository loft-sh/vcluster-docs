...
With vCluster Platform 4.12, use a Platform Stack when separate Apps or Argo CD Applications need explicit ordering. Stack tasks can wait for healthy dependencies and pass outputs to later tasks. See [Create a Stack template](/platform/administer/templates/create-stack-templates).
