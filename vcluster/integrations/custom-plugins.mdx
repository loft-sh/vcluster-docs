...
### Overview
vCluster plugins are Kubernetes operators that can access both the cluster and the control plane cluster, enabling advanced syncing, resource management, and custom automation.
