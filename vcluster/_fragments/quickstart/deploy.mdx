...
import TerraformDeployCustom from '!!raw-loader!@site/vcluster/_fragments/quickstart/terraform-deploy-custom.tf'
import TerraformDeployDefault from '!!raw-loader!@site/vcluster/_fragments/quickstart/terraform-deploy-default.tf'
