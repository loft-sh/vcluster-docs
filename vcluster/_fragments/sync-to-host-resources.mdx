...
vCluster also allows to sync custom resources via the [custom resource definitions syncer](../configure/vcluster-yaml/sync/to-host/advanced/custom-resource-definitions.mdx)
...
### Disabled by Default
* [CustomResourceDefinitions](../configure/vcluster-yaml/sync/to-host/advanced/custom-resource-definitions.mdx)
