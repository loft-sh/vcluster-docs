...
It's recommended to store your credentials to your OCI registry in a secret and reference the secret in the `vcluster.yaml` of your cluster configuration. This protects the details of your credentials.
