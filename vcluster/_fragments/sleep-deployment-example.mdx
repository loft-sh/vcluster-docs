...
<Flow id="sleepmode-deployment-example" title="Auto sleep deployment example" description="This example demonstrates how to configure and manage auto sleep functionality in clusters without using an agent.">
...
Use the following `vcluster.yaml` to create a cluster on your control plane cluster. Save this file as `vcluster.yaml`
...
Create demo deployments in your cluster.
