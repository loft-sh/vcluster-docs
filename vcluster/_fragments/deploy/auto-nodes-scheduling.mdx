...
:::warning
Newly introduced workloads and pods might be introduced across different vCluster versions which would require additional resources. When auto node is enabled in older versions, 
