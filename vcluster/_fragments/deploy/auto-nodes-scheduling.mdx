...
<PageVariables NODE_PROVIDER="my-node-provider" CUSTOM_PROPERTY="my-custom_property" CUSTOM_PROPERTY_VALUE="my-custom-value" NODE_POOL_NAME="my-node-pool" />
...
<InterpolatedCodeBlock
  code={`privateNodes:
    ...
    autoNodes:
      ...
      properties:
        [[GLOBAL:CUSTOM_PROPERTY]]: [[GLOBAL:CUSTOM_PROPERTY_VALUE]]
      dynamic:
        - name: [[GLOBAL:NODE_POOL_NAME]]`}
  language="yaml"
/>
...
<InterpolatedCodeBlock
  ...
  spec:
    template:
      metadata:
        labels:
          vcluster.loft.sh/provider-platform: [[GLOBAL:NODE_PROVIDER]]
      spec:
        requirements:
        - key: [[GLOBAL:CUSTOM_PROPERTY]]
          operator: In
          values:
            - [[GLOBAL:CUSTOM_PROPERTY_VALUE]]`}
  language="yaml"
/>
...
<InterpolatedCodeBlock
  ...
  kind: NodeClaim
  metadata:
    name: [[GLOBAL:NODE_POOL_NAME]]-j6b8n
  spec:
    requirements:
      - key: [[GLOBAL:CUSTOM_PROPERTY]]
        operator: In
      ...
      - key: node.kubernetes.io/instance-type
        operator: In
        values:
          - [[GLOBAL:NODE_PROVIDER]].large
          - [[GLOBAL:NODE_PROVIDER]].medium
    resources:
      requests:
        cpu: 120m
        memory: 114Mi
    ...
    requirements:
      ...
      - key: node.kubernetes.io/instance-type
        ...
        values:
          - [[GLOBAL:NODE_PROVIDER]].large
          - [[GLOBAL:NODE_PROVIDER]].medium
    providerRef: [[GLOBAL:NODE_PROVIDER]]
