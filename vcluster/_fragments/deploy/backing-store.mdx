...
Alternatively, you can use an [`emptyDir`](https://kubernetes.io/docs/concepts/storage/volumes/#emptydir) volume to store cluster data.
...
<p></p>
:::warning
vCluster snapshots aren't supported with this backing store. See [Back up and restore](../../configure/vcluster-yaml/control-plane/components/backing-store/etcd/deploy.mdx#back-up-and-restore).
:::
