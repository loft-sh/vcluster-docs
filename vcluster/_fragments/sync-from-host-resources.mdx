...
A good example would be nodes, which are nice to view inside the tenant cluster and can be also used to enabled certain features such as [scheduling inside the vCluster](../configure/vcluster-yaml/control-plane/other/advanced/virtual-scheduler.mdx),
