...
By default, only [Events](../configure/vcluster-yaml/sync/from-host/events.mdx) syncing is enabled. All other resource syncs are disabled unless explicitly turned on.
