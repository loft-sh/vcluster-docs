...
vCluster also allows to sync custom resources via the [custom resource definitions syncer](../configure/vcluster-yaml/sync/from-host/custom-resource-definitions.mdx)

### Enabled by Default
* [Events](../configure/vcluster-yaml/sync/from-host/events.mdx)

### Disabled by Default
* [CustomResourceDefinitions](../configure/vcluster-yaml/sync/from-host/custom-resource-definitions.mdx)
