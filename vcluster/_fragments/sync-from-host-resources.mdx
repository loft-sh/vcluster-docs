...
These labels are added as [management labels](/docs/vcluster/_fragments/sync-from-host-resources#added-by-the-virtual-cluster) when synching from the virtual cluster to the host cluster, but skipped when syncing from the host cluster to the virtual 
