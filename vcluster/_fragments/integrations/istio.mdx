...
If you are using [network policies](/vcluster/configure/vcluster-yaml/policies/network-policy), consult the [Ambient and Kubernetes NetworkPolicy](https://istio.io/latest/docs/ambient/usage/networkpolicy/) documentation.
