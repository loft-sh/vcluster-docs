...
You can integrate cert-manager with your cluster to manage TLS certificates across control plane and tenant environments.

## Prerequisites

<BasePrerequisites />

- cert-manager operator installed on your control plane cluster. For setup instructions, see the [cert-manager installation guide](https://cert-manager.io/docs/installation/).

<!-- vale off -->

## Enable the integration

Enable cert-manager integration in your cluster configuration:
...
- **Imports**: Cluster-scoped `ClusterIssuers` from your control plane cluster into the cluster
- **Exports**: Namespaced `Issuers` and `Certificates` from the cluster to the control plane cluster
- **Syncs**: Generated certificate secrets back to the cluster automatically


## Set up cluster contexts

Create or update a cluster following the [vCluster quick start guide](../../quick-start/shared-nodes.mdx).
Configure cluster contexts to simplify switching between control plane and clusters:
...
<Highlight color="secondary">Cluster</Highlight> Create a self-signed issuer
...
<Highlight color="secondary">Cluster</Highlight> Create a certificate
...
<Highlight>control plane cluster</Highlight> Create a root CA certificate

Create a self-signed root CA in the control plane cluster (ClusterIssuers are imported from control plane to cluster):
...
```bash title="Apply root CA in control plane cluster"
...
<Highlight>control plane cluster</Highlight> Create a CA issuer
...
```bash title="Apply CA issuer in control plane cluster"
...
<Highlight color="secondary">Cluster</Highlight> Issue certificates from your CA
...
```bash title="Apply certificate in cluster"
...
<Highlight color="secondary">Cluster</Highlight> Create an ACME issuer
...
<Highlight color="secondary">Cluster</Highlight> Create an ACME certificate
...
<Highlight color="secondary">Cluster</Highlight> Check certificate status
...
<Highlight color="secondary">Cluster</Highlight> Verify secret creation
...
<Highlight>control plane cluster</Highlight> Confirm synchronization

```bash title="Check control plane cluster resources"
