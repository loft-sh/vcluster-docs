...
The Netris integration enables vCluster to use [Netris](https://www.netris.io/) for network automation for the vCluster control plane and [private nodes](../../deploy/worker-nodes/private-nodes/overview.mdx).
...
- [BCM Node Provider with Netris](/docs/platform/next/vmetal/drivers/bare-metal/bcm)
- [KubeVirt Node Provider with Netris](/docs/platform/next/vmetal/drivers/virtual-machines/kubevirt)

## Configure Netris integration

1. Create a Secret in the control plane cluster in the namespace where vCluster Platform is installed to provide authentication and endpoint information:
...
:::info
This requires [Multus](https://github.com/k8snetworkplumbingwg/multus-cni) to be installed in the control plane cluster.
:::
...
For more information on manual kube-vip configuration, see [Kube-vip](../../configure/vcluster-yaml/control-plane/other/advanced/kube-vip.mdx).
