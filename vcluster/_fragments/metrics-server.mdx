...
If you are using [network policies](/vcluster/configure/vcluster-yaml/policies/network-policy), you need to add the metrics server pod to the allowed rules that the control plane can communicate with:
