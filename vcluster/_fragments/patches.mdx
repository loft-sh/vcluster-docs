...
:::info Namespace mode
With namespace mode, you only need to rewrite the references that explicitly include a namespace, such as `my-namespace/my-secret`. You can use the `namespacePath` option to specify the path of the namespace of the reference.
:::
