...
- `kubectl` installed
- `external-secrets` operator installed on your host cluster. For more information, see the [External Secrets Operator](https://external-secrets.io/latest/) documentation.
