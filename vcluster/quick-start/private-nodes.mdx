...
- [Auto Nodes](/docs/platform/next/vmetal/concepts/machine-types-and-nodetypes) — automate worker node provisioning through Platform instead of joining manually
