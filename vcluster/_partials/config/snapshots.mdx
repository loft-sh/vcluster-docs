...
Type specifies supported type of storage services for a snapshot S3/OCI/Container, see https://www.vcluster.com/docs/vcluster/next/operate/backup-restore#store-snapshots-in-s3-buckets
