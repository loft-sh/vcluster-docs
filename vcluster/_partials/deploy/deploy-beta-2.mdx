...
import TerraformDeployCustomBeta from '!!raw-loader!@site/vcluster/_partials/deploy/terraform-deploy-beta.tf'
import TerraformDeployDefaultBeta from '!!raw-loader!@site/vcluster/_partials/deploy/terraform-deploy.tf'
