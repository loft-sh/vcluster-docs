...
<PageVariables VCLUSTER_NAME="myvcluster" VCLUSTER_NAMESPACE="vcluster" VCLUSTER_VERSION="0.31.0"/>
...
Upgrade your CLI to the version of vCluster that you want to upgrade your cluster to.
