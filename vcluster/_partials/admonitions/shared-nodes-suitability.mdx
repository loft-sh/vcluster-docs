...
If you accept shared nodes for a trusted-tenant use case, follow the [shared-node hardening guide](../../design/security/shared-nodes-hardening.mdx) as the required next step.
:::
