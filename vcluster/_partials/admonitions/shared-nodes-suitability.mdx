...
If you accept shared nodes for a trusted-tenant use case, follow the [shared-node hardening guide](/docs/vcluster/security/shared-nodes-hardening) as the required next step.
:::
