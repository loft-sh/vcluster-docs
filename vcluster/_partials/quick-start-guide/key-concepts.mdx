...
- [**Worker Nodes**](../../configure/tenancy-model.mdx): Worker nodes can be either from the host cluster that the vCluster control plane is deployed on or independent private nodes.
