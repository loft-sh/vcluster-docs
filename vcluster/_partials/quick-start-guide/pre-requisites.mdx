...
* Access to a Kubernetes v1.28+ cluster with permissions to deploy applications into a namespace. This cluster acts as the Control Plane Cluster for the tenant cluster deployment.
