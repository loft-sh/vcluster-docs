...
This check interval—called the **Sleep Last Activity Update Interval**—defines how often the platform updates the “last active” timestamp for each environment.
