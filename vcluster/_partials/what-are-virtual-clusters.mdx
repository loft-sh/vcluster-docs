...
### Enhanced flexibility and compatibility
  ...
  - **Diverse Kubernetes environments:** vCluster supports different Kubernetes versions and distributions (including Kubernetes, and <GlossaryTerm term="k0s">K0s</GlossaryTerm>), allowing version skews. This makes it possible to tailor each virtual cluster to specific requirements without impacting others.
