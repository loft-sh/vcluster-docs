...
These policies run on the control plane cluster, outside vCluster, so they don't depend on a vCluster edition. You apply them with your own policy engine.
