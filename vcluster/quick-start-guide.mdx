...
This guide deploys a tenant cluster using the Shared Nodes default, which is suitable for testing and development. For production GPU workloads, Private Nodes provide dedicated infrastructure with full tenant isolation. See [Private Nodes deployment](./deploy/worker-nodes/private-nodes/README.mdx) to get started.
:::
