...
The vCluster Pro edition has [CoreDNS embedded](../vcluster-yaml/control-plane/components/coredns#controlPlane-coredns-embedded) directly into the virtual control plane pod, minimizing the overall footprint of each virtual cluster.
