...
sidebar_label: Backup & Restore vCluster
sidebar_position: 4
---
...
To use velero for making backups you need to enable the [hostpath-mapper](/docs/vcluster/vcluster-yaml/control-plane/components/host-path-mapper) component of vCluster.
