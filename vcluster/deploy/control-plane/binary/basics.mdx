...
import StandaloneAutoNodesEndpoint from '../../../_partials/admonitions/standalone-autonodes-endpoint.mdx';
...
To use vCluster Standalone as a control plane cluster for clusters, set your kubectl context to the vCluster Standalone instance. You can then create and manage clusters using the vCluster CLI.
