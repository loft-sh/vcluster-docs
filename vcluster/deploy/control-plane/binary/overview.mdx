...
slug: /deploy/control-plane/binary
---
...
:::info
These are minimal requirements suitable for testing and development. Production deployments should be sized based on your specific workload, cluster size, and the number of clusters you plan to run.
:::
...
| 3. [Join worker nodes](../../worker-nodes/private-nodes/overview.mdx) (optional) | Join worker nodes as private nodes. |
