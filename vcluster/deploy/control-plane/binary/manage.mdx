...
For the full configuration reference, see `config.yaml` in the [standalone configuration reference](../../../configure/vcluster-yaml/control-plane/components/standalone). Review the [standalone limitations](../binary/README#private-node-limitations) before changing settings.
