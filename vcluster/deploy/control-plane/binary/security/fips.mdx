...
<InterpolatedCodeBlock
  ...
  title="Install FIPS-complaint vCluster Standalone on control plane node"
  language="bash"
/>

As a result, vCluster Standalone will automatically use FIPS-complaint images and artifacts for vCluster Standalone and Kubernetes Components.
