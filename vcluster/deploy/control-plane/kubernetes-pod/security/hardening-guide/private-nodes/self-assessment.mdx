...
# Self-assessment guide for private nodes 
...
|:---------------------------------------------------|:------:|:------:|:---------------:|:------:|
| [Control plane security configuration](./control-plane-components.mdx) |  48 |   0  |  11  |  0  |
| [etcd node configuration](./etcd.mdx)                  |   7    |   0    |        0        |  0  |
| [Control plane configuration](./control-plane.mdx)     |   1    |   4    |        0        |  0  |
| [Worker node security configuration](./worker-node.mdx)|  23    |   0    |        1        |  0  |
| [Kubernetes Policies](./policies.mdx)                  |   7    |  26    |        0        |  2  |
