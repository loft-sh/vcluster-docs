...
# Self-assessment guide for host nodes
...
|:---------------------------------------------------|:------:|:------:|:---------------:|:------:|
| [Control plane security configuration](./control-plane-components.mdx) |  45 |   0  |  14  |  0  |
| [etcd node configuration](./etcd.mdx)                  |   7    |   0    |        0        |  0  |
| [Control plane configuration](./control-plane.mdx)     |   1    |   4    |        0        |  0  |
| [Worker node security configuration](./worker-node.mdx)|   0    |   0    |       24        |  0  |
| [Kubernetes Policies](./policies.mdx)                  |   9    |  24    |        0        |  2  |
