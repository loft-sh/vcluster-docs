...
- **vCluster Helm chart**—Typically retrieved from the [vCluster Labs Helm chart repository](https://charts.loft.sh/).
...
Before deploying vCluster, you must [create an access key](../../../../configure/vcluster-yaml/platform.mdx) to authenticate your cluster. This step is essential for connecting your air-gapped vCluster to the platform.
...
For more details on FIPS, refer to the [FIPS configuration guide](./fips.mdx).
