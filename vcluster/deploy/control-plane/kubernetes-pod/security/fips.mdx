...
<FeatureTable names="vcp-distro-fips" />
...
To use a different Kubernetes version in your cluster than the control plane cluster, set the `controlPlane.distro.k8s.image.tag` field in your configuration:
