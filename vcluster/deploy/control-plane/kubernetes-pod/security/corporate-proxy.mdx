...
The proxy configuration shown previously applies only to the vCluster control plane. If you need proxy settings for workloads running inside the cluster, configure them separately through:
...
- [Deploy vCluster in an air-gapped environment](./air-gapped.mdx)
- [StatefulSet configuration](../../../../configure/vcluster-yaml/control-plane/deployment/statefulset.mdx)
- [vCluster networking](../../../../configure/vcluster-yaml/networking/README.mdx)
