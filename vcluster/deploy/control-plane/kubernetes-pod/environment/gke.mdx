...
Now that you have vCluster running on GKE, consider setting up the [platform UI](/platform/install/quick-start-guide) to manage your clusters.

## Workload Identity

When using the platform you can easily enable [Workload Identity](../../../../third-party-integrations/pod-identity/gke-workload-identity.mdx).
