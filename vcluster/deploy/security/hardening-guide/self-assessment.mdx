...
- [Control plane security configuration](./control-plane-components)

- [etcd node configuration](./etcd)

- [Control plane configuration](./control-plane)

- [Worker node security configuration](./worker-node)

- [Kubernetes Policies](./policies)


Review the assessment sections and map them to your vCluster configuration to ensure that your hardened deployment not only follows security best practices but is also auditable and defensible in a compliance context.