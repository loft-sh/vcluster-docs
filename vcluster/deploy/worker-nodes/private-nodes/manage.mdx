...
After the change, vCluster upgrades the control plane API automatically. If automatic worker node upgrades are configured, kubelet and other components on those nodes are also upgraded.
