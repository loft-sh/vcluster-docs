...
repositories used to reference the FIPS images.
...
Connecting private nodes for FIPS-compliant vCluster is exactly the same process, as for non FIPS-compliant.
vCluster will automatically recognize it is running in FIPS-compliant mode and use the FIPS-compliant bundle and images for Kubernetes components.
