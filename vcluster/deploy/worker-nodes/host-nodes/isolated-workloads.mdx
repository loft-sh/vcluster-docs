...
See the [shared-node hardening guide](../../../design/security/shared-nodes-hardening.mdx#node-scheduling-and-isolation) for the full scheduling and node isolation model.
