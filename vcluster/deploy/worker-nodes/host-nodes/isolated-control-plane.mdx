...
This feature is deprecated as of v0.27 and will be removed in v0.28. 
:::
...
If you don't want to have your workloads running in the same namespace of the same host cluster, you can enable the isolated control plane feature,
