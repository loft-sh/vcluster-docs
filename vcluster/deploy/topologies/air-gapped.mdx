...
### Configuring your vCluster to point to the appropriate Helm chart location and image registry
...
### Configuring image pull secret for image registry
...
## Configuring FIPS images

Refer to the [FIPS configuration guide](/vcluster/deploy/security/fips).

<details>
  <summary>FIPS configuration example</summary>
  <FipsConfig />
</details>
