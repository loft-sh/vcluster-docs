...
a Kubernetes cluster that doesn't have access to the internet, aka an air-gapped environment. 
...
<Flow id="offline-images">
  ...
  :::note 
  When pushing images into your private registry, the original private registry will be removed and the repository and image name are uploaded. This allows vCluster to set your private registry to use for all images used in deploying vCluster. 
  :::
