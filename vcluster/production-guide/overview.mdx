...
- **Repeatable provisioning:** new tenant clusters deploy from a defined template, not from manual steps. When each environment also needs the same ordered set of applications, use [Stacks](/docs/platform/understand/what-are-stacks) to standardize that software layer
...
| Back up and restore tenant clusters | [Snapshots](../operate/backup-restore/backup.mdx), [restore](../operate/backup-restore/restore.mdx), [Velero](../operate/backup-restore/velero.mdx) |
...
| Upgrade Platform and tenant clusters | [Upgrade vCluster](../operate/upgrade/upgrade-version.mdx), [upgrade Platform](/docs/platform/maintenance/upgrade-migrate/upgrade), [lifecycle policy](/docs/platform/maintenance/upgrade-migrate/lifecycle-policy) |
| Rotate certificates | [Certificate rotation](../operate/certificates.mdx) |
| Manage private worker nodes | [Manage private nodes](../deploy/worker-nodes/private-nodes/manage.mdx), [Auto Nodes](/docs/platform/next/vmetal/concepts/machine-types-and-nodetypes) |
...
| Troubleshoot incidents | [vCluster troubleshoot](../operate/troubleshoot/noexec-emptydir-volumes.mdx), [debug commands](../cli/vcluster_debug.md), [Platform troubleshooting](/docs/platform/troubleshoot/connected-cluster-connectivity) |
