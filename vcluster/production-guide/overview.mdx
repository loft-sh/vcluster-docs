...
| Manage private worker nodes | [Manage private nodes](../deploy/worker-nodes/private-nodes/manage.mdx), [Auto Nodes](/docs/platform/vmetal/concepts/machine-types-and-nodetypes) |
