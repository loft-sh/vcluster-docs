...
| Operation | Read next |
| --- | --- |
| Monitor the distributed fleet | [Fleet Observability](/platform/maintenance/observability/overview), [other architectures](/docs/platform/next/maintenance/monitoring/fleet-metrics-architectures) |
