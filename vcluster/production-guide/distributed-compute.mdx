...
| Operation | Read next |
| --- | --- |
| Monitor the distributed fleet | [Fleet Observability](/platform/maintenance/observability/overview), [choose a different path](/platform/maintenance/monitoring/choose-a-fleet-metrics-path) |
