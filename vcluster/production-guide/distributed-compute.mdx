...
**Typical stack:** Central Platform (global). Per-DC Standalone <GlossaryTerm term="control-plane">control plane</GlossaryTerm> cluster. Private GPU nodes co-located with each Standalone instance. vMetal for owned bare metal sites.
...
| Operation | Read next |
| --- | --- |
| Monitor the distributed fleet | [Fleet Observability](/platform/maintenance/observability/overview), [choose a different path](/docs/platform/next/maintenance/monitoring/choose-a-fleet-metrics-path) |
