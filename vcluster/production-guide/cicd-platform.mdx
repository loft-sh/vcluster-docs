...
<figure>
  <img
    ...
    alt="CI/CD architecture: central control plane that creates tenant clusters on demand as needed"
  />
  <figcaption>Central control plane spinning up and down ephemeral clusters on demand</figcaption>
</figure>
