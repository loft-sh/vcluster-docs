...
| Operation | Read next |
| --- | --- |
| Monitor concurrent cluster count and node utilization during peak load | [Fleet Observability](/platform/maintenance/observability/overview), [other architectures](/docs/platform/next/maintenance/monitoring/fleet-metrics-architectures) |
