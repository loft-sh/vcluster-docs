...
| Operation | Read next |
| --- | --- |
| Monitor concurrent cluster count and node utilization during peak load | [Fleet Observability](/platform/maintenance/observability/overview), [choose a different path](/platform/maintenance/monitoring/choose-a-fleet-metrics-path) |
