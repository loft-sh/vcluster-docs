...
| Operation | Read next |
| --- | --- |
| Monitor concurrent cluster count and node utilization during peak load | [Fleet Observability](/platform/maintenance/observability/overview), [choose a different path](/docs/platform/next/maintenance/monitoring/choose-a-fleet-metrics-path) |
