...
| Plan image caching | [Pull-through registry](../configure/vcluster-yaml/control-plane/other/coredns.mdx) | Decide whether CI clusters pull images directly from registries or use a cache. Warm cache significantly reduces job time. |
