...
| --- | --- | --- |
| Review the architecture overview | [AI Factory Architecture Overview](../introduction/ai-factory-architecture-overview.mdx) | Full stack diagram and layer-by-layer decisions covering bare metal, control plane, tenant isolation, networking, storage, observability, and identity. |
