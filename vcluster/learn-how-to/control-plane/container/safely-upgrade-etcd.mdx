  ...
  <TabItem value="embedded" label="Embedded ETCD">
    ...
    <Tabs>
      <TabItem value="v0.26" label="vCluster v0.26.[0-4]">
        First upgrade to v0.26.5, it uses ETCD v3.5.24. Then, your ETCD data will be saved in a format compatible with upgrade to v3.6
      </TabItem>
      <TabItem value="v0.27" label="vCluster v0.27.[0-2]">
        First upgrade to v0.27.3, it uses ETCD v3.5.24. Then, your ETCD data will be saved in a format compatible with upgrade to v3.6
      </TabItem>
      <TabItem value="v0.28" label="vCluster v0.28.[0-1]">
        First upgrade to v0.28.2, it uses ETCD v3.5.24. Then, your ETCD data will be saved in a format compatible with upgrade to v3.6
      </TabItem>
    </Tabs>
