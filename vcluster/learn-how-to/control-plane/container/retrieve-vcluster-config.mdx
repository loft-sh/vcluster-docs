...
The vCluster CLI provides a comprehensive view of your cluster configuration, showing both user-defined settings and applied defaults. Use the following command when you need the complete effective configuration that vCluster uses to manage your cluster:
