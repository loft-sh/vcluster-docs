...
This command allows you to access services running inside the cluster from your local machine without exposing them publicly through the control plane cluster’s services or ingress.
