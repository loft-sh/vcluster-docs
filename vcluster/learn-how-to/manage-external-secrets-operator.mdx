---
title: Manage the External Secrets Operator
sidebar_label: Manage the External Secrets Operator
...
:::note 
A direct [ESO integration](https://www.vcluster.com/docs/vcluster/configure/vcluster-yaml/integrations/eso) is available as a [Pro feature](https://website.vcluster.com/enterprise-demo).
:::
...
1. Create a configuration file `vcluster-config.yaml` with this content, which uses `namespaceMode` required for syncing CRDs:
