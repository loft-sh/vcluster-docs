...
:::note 
A direct [ESO integration](https://www.vcluster.com/docs/vcluster/configure/vcluster-yaml/integrations/eso) is available as an [Enterprise feature](https://website.vcluster.com/enterprise-demo).
:::
