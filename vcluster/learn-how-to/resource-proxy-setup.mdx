...
- Keep proxy traffic off the DERP relay and set up monitoring. See [Operate the resource proxy](../operate/resource-proxy-operations.mdx).
- If something isn't working, start with the quick triage. See [Troubleshoot the resource proxy](../operate/troubleshoot/resource-proxy.mdx).
