...
:::important  
This guide only supports the K8S distribution and Embedded Etcd as the backing store.  
...
Below is a reference value file with minimum required configuration for a hardened installation. This needs to be used in combination with the above runtime level settings and other measures to achieve full compliance.
...
- **Section 4: Worker Node Security Configuration**<br/>
...
- NOT APPLICABLE - The control is not applicable to vCluster because of how it is designed to operate. The remediation section will explain why this is so.
