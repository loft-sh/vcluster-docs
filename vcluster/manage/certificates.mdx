...
steps necessary before or after cert rotation. Though, you still have to
manually delete all `NodeClaims` that have previously been joined to the
...
The following shows a NodeClaim using kubectl:
...
Say you have rotated the CA certificate of the virtual cluster names "vcluster" you would have to delete the NodeClaim named "vcluster-4zbg8":
