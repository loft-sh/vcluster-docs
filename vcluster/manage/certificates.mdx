...
If the rotation fails, you can restore the previous PKI from the automatically created backup. For more information, see [restoring the previous CA from a backup](#restore-the-previous-ca-from-a-backup) for recovery steps.
:::
