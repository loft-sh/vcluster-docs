...
After a CA rotation or restoration, you neeed to delete all `NodeClaims` from vCluster Platform that have previously joined the
virtual cluster.

:::info Pre-Requisities
- kubectl context access to the cluster hosting vCluster Platform 
:::
...
<Flow> 
  ...
  <Step> 
    ...
    From the list of `NodeClaims`, identify the ones associated to your virtual cluster that had the CA certifiate change.
