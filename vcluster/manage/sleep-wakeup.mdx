...
- **Automatic sleep**: Configure the vCluster to automatically sleep and wake based on inactivity detection, schedules, or ingress activity. This is an enterprise feature. For details, see the [Sleep configuration documentation](../configure/vcluster-yaml/sleep.mdx).
...
For automatic sleep with activity detection, scheduling, and other advanced features, see the [Sleep configuration documentation](../configure/vcluster-yaml/sleep.mdx).
...
For automatic sleep configuration, see the [Sleep configuration documentation](../configure/vcluster-yaml/sleep.mdx).
