...
- Ensure your vCluster is running version 0.24.2 or later
- Back up your vCluster data (see [backup guide](/vcluster/manage/backup-restore/backup))
- Verify the deployed etcd is healthy and accessible
- Have sufficient storage for the embedded etcd PVC
