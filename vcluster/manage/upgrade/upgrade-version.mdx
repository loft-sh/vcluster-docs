...
You cannot change distros or backing store once a cluster is deployed, with one exception: starting with vCluster 0.25.0, migration from K3s to K8s distro is supported. For more details, see the [K3s to K8s Migration](./distro-migration.mdx).
:::
...
- Name of the cluster
- Namespace of where the cluster is deployed
