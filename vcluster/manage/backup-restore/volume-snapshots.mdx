...
Please see our [Lifecycle Policy](../../deploy/upgrade/supported_versions#feature-versioning) for more information.
:::
...
Note that if a PVC already exists in the cluster, the snapshot feature will not overwrite it. You will need to delete it and run the restore again. 
