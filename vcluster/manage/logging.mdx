...
Use the [Central HostPath Mapper](/docs/platform/next/maintenance/logging/central-hostpath-mapper). It installs a single DaemonSet on the control plane cluster that handles path remapping for all tenant clusters.
