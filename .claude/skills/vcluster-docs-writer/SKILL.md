...
- **"vCluster Pro" does not exist** as a product — don't use it. "Pro" labels license-gated features inside vCluster (unlocked via vCluster Platform entitlement), not a separate product or tier.
